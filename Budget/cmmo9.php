...
$result = $db->prepare("SELECT SUM(total) AS total FROM mmoco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mayors Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmmo1">January</a></li>
					<li><a href="cmmo2">February</a></li>
					<li><a href="cmmo3">March</a></li>
					<li><a href="cmmo4">April</a></li>
					<li><a href="cmmo5">May</a></li>
					<li><a href="cmmo6">June</a></li>
					<li><a href="cmmo7">July</a></li>
					<li><a href="cmmo8">August</a></li>
					<li><a href="cmmo9">September</a></li>
					<li><a href="cmmo10">October</a></li>
					<li><a href="cmmo11">November</a></li>
					<li><a href="cmmo12">December</a></li>
...
<h2>Mayor's Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mmo,2); ?></span></li>
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mmo - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM mmoco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM mmoco WHERE yearm = ? ");

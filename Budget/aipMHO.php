...
$isLoaded = check_if_loaded_mho_aip();
		if ($isLoaded == '1'){
			...
			header("location: aipMHO_readonly");
			}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, sector, refCode, salaries, PERA, RA, TA, clothing_allowance, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, healthWorkersBenefits, other_personal, total_ps,
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="hwb" name="hwb" class="form-control" step="any" ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 060</td>
			<td><input type="number" id="vehicle-maintenance" name="vehicle-maintenance" class="form-control" step="any" ></td>

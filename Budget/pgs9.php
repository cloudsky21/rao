...
$result = $db->prepare("SELECT SUM(total) AS total FROM psgs WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS Report | General Services</title>
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_gs_ps">Export to Excel</a></li>
							<li><a href="personal_services_gs_all">Personal Services</a></li>
							<li><a href="mooe_gs_all">Maint. and Other Operating Expenses</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pgs1">January</a></li>
							<li><a href="pgs2">February</a></li>
							<li><a href="pgs3">March</a></li>
							<li><a href="pgs4">April</a></li>
							<li><a href="pgs5">May</a></li>
							<li><a href="pgs6">June</a></li>
							<li><a href="pgs7">July</a></li>
							<li><a href="pgs8">August</a></li>
							<li><a href="pgs9">September</a></li>
							<li><a href="pgs10">October</a></li>
							<li><a href="pgs11">November</a></li>
							<li><a href="pgs12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>General Services <br><small>Personal Services (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
				...
				<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_gs,2); ?></span></li>
				<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_gs - $ps_september_total,2); ?></span></li>
			...
			<table class="table table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM psgs WHERE year_transact = ? AND month_transact = ? ORDER BY alobs DESC");

...
$sqlExcel = "SELECT * FROM psmeo WHERE year_transact = '$yy'";
...
$objPHPExcel->getActiveSheet()->setTitle('PSMEO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Engineering Office');

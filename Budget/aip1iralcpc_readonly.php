	...
	<div style="margin-top:100px;">
		<div class="page-header"><h2>Programmed Appropriation and Obligation</h2></div>
			<form action="" method="POST">
				<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>1% IRA - LCPC</strong></label>  
		...
		<?PHP 
		$tablename = "lcpc_list_".$_SESSION['budget']; //mdr_list_(current Year) table
		...
		foreach($mdrCyTbl as $list){
			...
			$table2 = "lcpc".$_SESSION['budget']; //noneoffice_CY table
			$codelist = $list['code'];
			...
			$tablerao = "rlcpc".$_SESSION['budget'];

...
<h2>Mun. Treasurer's Office <br><small>Personal Services (January <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mto - $ps_jan_total,2); ?></span></li>

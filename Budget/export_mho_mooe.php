...
$sqlExcel = "SELECT * FROM mhomooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->setTitle('MOOEMHO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Health Office');
...
$objPHPExcel->getActiveSheet()->SetCellValue('H13','Office Supplies');
$objPHPExcel->getActiveSheet()->SetCellValue('H14','05   02   03   010');

$objPHPExcel->getActiveSheet()->SetCellValue('I13','Motor Vehicle Maintenance');
$objPHPExcel->getActiveSheet()->SetCellValue('I14','05   02   13   060');

$objPHPExcel->getActiveSheet()->SetCellValue('J13','Telephone / Telegraph and Internet');
$objPHPExcel->getActiveSheet()->SetCellValue('J14','05   02   05   030');
...
foreach ($result as $row)
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount,$row['motor_vehicle_maint']);
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount,$row['telephone_telegraph']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow, get_total_mm());	
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_telephone());
...
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow1, get_mm_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_telephone_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$getRow2, get_aip_offsup());
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow2, get_aip_mm());
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow2, get_aip_telephone());

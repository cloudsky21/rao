...
catch(Exception $e)
{
	...
	header('Refresh: 3; url=aip1spsetup');
	exit();
...
<head>
	...
	<title>Report | Senior Citizens & Persons With Disabilities</title>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pd1">January</a></li>
							<li><a href="pd2">February</a></li>
							<li><a href="pd3">March</a></li>
							<li><a href="pd4">April</a></li>
							<li><a href="pd5">May</a></li>
							<li><a href="pd6">June</a></li>
							<li><a href="pd7">July</a></li>
							<li><a href="pd8">August</a></li>
							<li><a href="pd9">September</a></li>
							<li><a href="pd10">October</a></li>
							<li><a href="pd11">November</a></li>
							<li><a href="pd12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>1% Senior Citizens & Persons With Disabilities <br><small>September <?php echo $_SESSION['budget'] ?></small></h2>
			...
			<ul class="list-group col-sm-4">
				...
				<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_pd,2); ?></span></li>
				<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_pd - $nt_9, 2); ?></span></li>

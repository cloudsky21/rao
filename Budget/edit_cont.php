...
$table="rcont".$_SESSION['budget'];
$table_list_20 = "cont_list_".$_SESSION['budget'];
...
<div class="form-group">
	<label for="rao" class="control-label col-sm-4">Program <strong><i>Capital Outlay</i></strong></label>	
		<div class="col-sm-8">	

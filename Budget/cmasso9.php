...
include("cfg.php");
include("functions_co_masso.php");
...
$result = $db->prepare("SELECT SUM(total) AS total FROM massoco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mun. Assessors Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmasso1">January</a></li>
					<li><a href="cmasso2">February</a></li>
					<li><a href="cmasso3">March</a></li>
					<li><a href="cmasso4">April</a></li>
					<li><a href="cmasso5">May</a></li>
					<li><a href="cmasso6">June</a></li>
					<li><a href="cmasso7">July</a></li>
					<li><a href="cmasso8">August</a></li>
					<li><a href="cmasso9">September</a></li>
					<li><a href="cmasso10">October</a></li>
					<li><a href="cmasso11">November</a></li>
					<li><a href="cmasso12">December</a></li>
...
<h2>Mun. Assessors's Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_masso - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM massoco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM massoco WHERE yearm = ? ");

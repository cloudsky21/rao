...
$result = $db->prepare("SELECT SUM(total) AS total FROM mboco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mun. Budget Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmbo1">January</a></li>
					<li><a href="cmbo2">February</a></li>
					<li><a href="cmbo3">March</a></li>
					<li><a href="cmbo4">April</a></li>
					<li><a href="cmbo5">May</a></li>
					<li><a href="cmbo6">June</a></li>
					<li><a href="cmbo7">July</a></li>
					<li><a href="cmbo8">August</a></li>
					<li><a href="cmbo9">September</a></li>
					<li><a href="cmbo10">October</a></li>
					<li><a href="cmbo11">November</a></li>
					<li><a href="cmbo12">December</a></li>
...
<h2>Mun. Budget Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mbo - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM mboco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM mboco WHERE yearm = ? ");

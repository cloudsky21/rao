...
<img src="saaoblogo.jpg" style="float: left;">
				<p class="text-center">Republic of the Philippine<br><strong>PROVINCE OF LEYTE</strong><br>Local Government Unit-Tolosa, Leyte<br><br><strong>STATUS OF APPROPRIATIONS, ALLOTMENTS AND OBLIGATIONS <br>GENERAL FUND</strong><br>As of <label>August</label> <?PHP echo $_SESSION['budget'] ?></p>
</div>
		...
		$result->execute(["MMO",$_SESSION['budget']]);
			...
			foreach($result as $row){
				...
				/*----- Obligations ----- */
					...
					$obligation->execute([$_SESSION['budget'],"08"]);
				...
				$all_list_name_20 = $row['propername'];
					...
					foreach($rs as $i){
						...
						echo '<tr>';
							...
							$obligation_20->execute([$_SESSION['budget'],"08"]);
				...
				$all_list_name_noneoffice = $row['propername'];
					...
					foreach($rs as $i){
						...
						echo '<tr>';
							...
							$obligation_noneoffice->execute([$_SESSION['budget'],"08"]);

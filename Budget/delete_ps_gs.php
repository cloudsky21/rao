...
$query = "DELETE FROM psgs WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | General Services</title>
...
<body>
<label id="accountTitle">Personel Services - General Services - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_gs.php"  class="active">PLAZA</a></li>
</ul>
  </div>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_gs_all.php">Personal Services</a>
  <a href="mooe_gs_all.php">Maint. and Other Operating Expenses</a>

...
$query = "DELETE FROM pslcr WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Local Civil Registrar</title>
...
<body>
<label id="accountTitle">Personel Services - LCR - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_lcr.php"  class="active">LCR</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_lcr_all.php">Personal Services</a>
  <a href="mooe_lcr_all.php">Maint. and Other Operating Expenses</a>
...
$result = $db->prepare("SELECT * FROM pslcr WHERE year_transact =?");

...
$result = $db->prepare("SELECT SUM(total) AS total FROM mtoco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mun. Treasurers Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmto1">January</a></li>
					<li><a href="cmto2">February</a></li>
					<li><a href="cmto3">March</a></li>
					<li><a href="cmto4">April</a></li>
					<li><a href="cmto5">May</a></li>
					<li><a href="cmto6">June</a></li>
					<li><a href="cmto7">July</a></li>
					<li><a href="cmto8">August</a></li>
					<li><a href="cmto9">September</a></li>
					<li><a href="cmto10">October</a></li>
					<li><a href="cmto11">November</a></li>
					<li><a href="cmto12">December</a></li>
...
<h2>Mun. Treasurers's Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mto - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM mtoco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM mtoco WHERE yearm = ? ");

...
<thead>
	...
	<th style="text-align:center;">Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="equipment" name="equipment" class="form-control" value="'.$offeq.'" tabindex="20" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_equip_maint_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control" value="'.$coo.'" tabindex="22" step="any"></td>';

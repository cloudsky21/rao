...
<h2>Mun. Planning and Development's Office <br><small>Capital Outlay (February <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mpdo - $total_2,2); ?></span></li>

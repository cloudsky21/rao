...
<h2>Mun. Agriculturist's Office <br><small>Capital Outlay (November <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mao - $total_11,2); ?></span></li>

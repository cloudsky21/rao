...
$checkTableExist = get_table_exist_sef();

if($checkTableExist == '0'){

$isLoaded = check_if_loaded_sef_aip();
		if ($isLoaded > 0){
	
			
			header("location: aipsef_readonly");
			exit();
			}
...
<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>Special Education Fund (SEF)</strong></label>  

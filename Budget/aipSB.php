...
if ($isLoaded == '1'){
	...
	header("location: aipSB_readonly");
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	// $post_total_personal_services =   $_POST['total-personal-services']);
	$post_tev =   $_POST['tev'];
...
<thead>
	...
	<th style="text-align: center;">Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			<td colspan=4><STRONG>Other Compensations:</STRONG></td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 040</td>
			<td><input type="number" id="ecc" name="ecc" class="form-control"   step="any"></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="terminal-leave" name="terminal-leave" class="form-control"  step="any" min=0  ></td>
		
		</tr>
		
		<tr>
			<td colspan="4"><strong>Others (Specify)</strong></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="personel" name="personel" class="form-control"  step="any" min=0  ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 05 &#32; 030</td>
			<td><input type="number" id="telephone" name="telephone" class="form-control"   step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 16 &#32; 020</td>
			<td><input type="number" id="fedility-premium" name="fedility-premium" class="form-control"   step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 99 &#32; 010</td>
			<td><input type="number" id="ads" name="ads" class="form-control"   step="any"></td>
		...
		<tr>
			...
			<td>1&#32;07&#32;05&#32;020</td>
			<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control"  ></td>

...
$query = "DELETE FROM maoco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Agriculturists Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_mao.php"  class="active">MAO</a></li>
...
$result = $db->prepare("SELECT * FROM maoco WHERE yearm =?");

...
$query = "DELETE FROM mbeco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Business Enterprise
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_mbe.php"  class="active">MARKET</a></li>
...
$result = $db->prepare("SELECT * FROM mbeco WHERE yearm =?");

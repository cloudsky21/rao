...
<h2>Sangguniang Bayan's Office <br><small>Capital Outlay (April <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_sb - $total_4,2); ?></span></li>

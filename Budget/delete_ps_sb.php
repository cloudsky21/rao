...
$query = "DELETE FROM pssb WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Sangguniang Bayan</title>
...
<body>
<label id="accountTitle">Personel Services - Sangguniang Bayan - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			<li><a href="delete_ps_mmo.php">MMO</a></li>
			<li><a href="delete_ps_sb.php"  class="active">SB</a></li>
			...
			<li><a href="delete_ps_mto.php">MTO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_sb_all.php">Personal Services</a>
  <a href="mooe_sb_all.php">Maint. and Other Operating Expenses</a>
...
$result = $db->prepare("SELECT * FROM pssb WHERE year_transact =?");

...
<title>MOOE Report | General Services</title>
...
<h2>General Services <br><small>Maintenance and Other Operating Expenses (September <?php echo $_SESSION['budget'] ?>)</small></h2>
...
$result = $db->prepare("SELECT * FROM gsmooe WHERE yearm = ? AND month = ? ORDER BY alobs DESC");

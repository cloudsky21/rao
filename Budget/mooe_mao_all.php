...
//numbers	
	...
	$totalObligation = $post_tev + $post_trainings  + $post_telephone + $post_supplies +  $post_eq;

	$query = "INSERT INTO maomooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM maomooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE maomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM maomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Agriculturist Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mao_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mao_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mao_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mao_mooe">Export to Excel</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmao1">January</a></li>
							<li><a href="mmao2">February</a></li>
							<li><a href="mmao3">March</a></li>
							<li><a href="mmao4">April</a></li>
							<li><a href="mmao5">May</a></li>
							<li><a href="mmao6">June</a></li>
							<li><a href="mmao7">July</a></li>
							<li><a href="mmao8">August</a></li>
							<li><a href="mmao9">September</a></li>
							<li><a href="mmao10">October</a></li>
							<li><a href="mmao11">November</a></li>
							<li><a href="mmao12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td><input type="number" step="any" name="eq" min=0 class="form-control"></td>
							</tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Agriculturist Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM maomooe WHERE yearm = ?");

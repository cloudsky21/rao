...
$checkTableExist = get_table_exist();

if($checkTableExist == "0"){

$isLoaded = check_if_loaded_20();
		if ($isLoaded == '1'){
	
			header("location: edf_readonly");
			exit();
			}
...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Departments
		...
		<ul class="dropdown-menu">
			...
			<li><a href="aipGAD">GAD</a></li>
			<li><a href="aipMDR">MDR</a></li>
			<li><a href="aip1SP">1% SC & PWDs</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
		<li><a href="#"  data-toggle="modal" data-target="#addObl"  data-backdrop="static" data-keyboard="false"><span class="glyphicon glyphicon-plus"></span></a></li>

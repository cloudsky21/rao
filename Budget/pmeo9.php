...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmeo WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS Report | Mun. Engineerings Office</title>
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mooe_meo_all">Maint. and Other Operating Expenses</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmeo1">January</a></li>
							<li><a href="pmeo2">February</a></li>
							<li><a href="pmeo3">March</a></li>
							<li><a href="pmeo4">April</a></li>
							<li><a href="pmeo5">May</a></li>
							<li><a href="pmeo6">June</a></li>
							<li><a href="pmeo7">July</a></li>
							<li><a href="pmeo8">August</a></li>
							<li><a href="pmeo9">September</a></li>
							<li><a href="pmeo10">October</a></li>
							<li><a href="pmeo11">November</a></li>
							<li><a href="pmeo12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Mun. Engineering's Office <br><small>Personal Services (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
				...
				<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_meo - $ps_september_total,2); ?></span></li>
			...
			<table class="table table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM psmeo WHERE year_transact = ? AND month_transact = ? ORDER BY alobs DESC");

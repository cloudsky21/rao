...
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow, get_total_hon());	
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow, get_total_yearend());		
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow, get_total_cashgft());	
$objPHPExcel->getActiveSheet()->SetCellValue('N'.$getRow, get_total_mid_year());
$objPHPExcel->getActiveSheet()->SetCellValue('O'.$getRow, get_total_pib());	
$objPHPExcel->getActiveSheet()->SetCellValue('P'.$getRow, get_total_gsis());		
$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$getRow, get_total_hdmf());	
$objPHPExcel->getActiveSheet()->SetCellValue('R'.$getRow, get_total_care());	
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow, get_total_ecc());
$objPHPExcel->getActiveSheet()->SetCellValue('T'.$getRow, get_total_tlb());	
$objPHPExcel->getActiveSheet()->SetCellValue('U'.$getRow, get_total_others());
...
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow1, get_hon_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow1, get_yearend_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow1, get_cashgft_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('N'.$getRow1, get_mid_year_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('O'.$getRow1, get_pib_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('P'.$getRow1, get_gsis_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$getRow1, get_hdmf_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('R'.$getRow1, get_care_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow1, get_ecc_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('T'.$getRow1, get_tlb_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('U'.$getRow1, get_others_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow2, get_aip_hon());
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow2, get_aip_yend());
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow2, get_aip_cash());
$objPHPExcel->getActiveSheet()->SetCellValue('N'.$getRow2, get_aip_mid());
$objPHPExcel->getActiveSheet()->SetCellValue('O'.$getRow2, get_aip_pib());
$objPHPExcel->getActiveSheet()->SetCellValue('P'.$getRow2, get_aip_gsis());
$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$getRow2, get_aip_hdmf());
$objPHPExcel->getActiveSheet()->SetCellValue('R'.$getRow2, get_aip_ph());
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow2, get_aip_ecc());
$objPHPExcel->getActiveSheet()->SetCellValue('T'.$getRow2, get_aip_tlb());
$objPHPExcel->getActiveSheet()->SetCellValue('U'.$getRow2, get_aip_other());

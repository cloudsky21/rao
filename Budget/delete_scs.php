...
$query = "DELETE FROM sc WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete 1&#37; Senior Citizen</title>
...
<body>
<label id="accountTitle">1&#37; Senior Citizen
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_scs.php" class="active">1% SC</a></li>
			<li><a href="delete_pwds.php">1% PWDs</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="scs.php">RAO 1&#37; Senior Citizen</a>
...
$result = $db->prepare("SELECT * FROM sc WHERE yearm =?");

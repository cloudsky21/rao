...
$isLoaded = check_if_loaded_masso_aip();
		if ($isLoaded == '1'){
	
			header("location: aipMASSO_readonly");
			exit();
		}
?>
...
<?PHP
	...
	$dept_code = "MASSO";
	$dept_head = "MYRNA T. SILVANO";
	$dept_name = "Municipal Assesors Office";
...
<thead>
	...
	<th style="text-align:center;">Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 050</td>
			<td><input type="number" id="equipment" name="equipment" class="form-control" step="any" ></td>
		...
		<tr>
			<td colspan="3"><button class="btn btn-success form-control" type="submit" value="SUBMIT">Submit</button></td>
		</tr>

...
<h2>Mun. Treasurers's Office <br><small>Capital Outlay (May <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mto - $total_5,2); ?></span></li>

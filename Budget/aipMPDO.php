...
$isLoaded = check_if_loaded_mpdo_aip();
		if ($isLoaded == '1'){
			...
			header("location: aipMPDO_readonly");
			}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, sector, refCode, salaries, PERA, RA, TA, clothing_allowance, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, other_allowance_bonuses, total_ps,
...
<thead>
	...
	<th style="text-align: center;">Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="oba" name="oba" class="form-control" step="any"  ></td>

...
$result->execute([$total, "MMO", $_SESSION['budget']]);
/* ------------------------------*/
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmmo WHERE alobs = ?");
	$result->execute([$rec]);
...
if(isset($_POST['submit_edit_ps_mmo'])){
...
//numbers	
	...
	$totalObligation = $post_salary + $post_pera +$post_ra+ $post_ta + $post_cloth + $post_hon + $post_yend + $post_gft + $post_mid + $post_pib + $post_gsis + $post_hdmf + $post_care + $post_ecc + $post_others + $post_tlb;

	$query = "UPDATE psmmo SET  
	year_transact=?, 
	month_transact=?, 
	day_transact=?, 
	alobs=?, 
	...
	$result->execute([
		...
		$post_others, 
		$post_tlb,
		$totalObligation,$_POST['alobs_edit']]);  
...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmmo WHERE year_transact = ? AND month_transact = ?");
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mmo_ps">Export to Excel</a></li>
							<li><a href="mooe_mmo_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_mmo_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmmo1">January</a></li>
							<li><a href="pmmo2">February</a></li>
							<li><a href="pmmo3">March</a></li>
							<li><a href="pmmo4">April</a></li>
							<li><a href="pmmo5">May</a></li>
							<li><a href="pmmo6">June</a></li>
							<li><a href="pmmo7">July</a></li>
							<li><a href="pmmo8">August</a></li>
							<li><a href="pmmo9">September</a></li>
							<li><a href="pmmo10">October</a></li>
							<li><a href="pmmo11">November</a></li>
							<li><a href="pmmo12">December</a></li>
							...
							<tbody>
								...
								<tr>
									...
									<tr>
										...
										<td><input type="number" step="any" name="honoraria" class="form-control"></td>
									</tr>
									<tr>
		...
		<div class="container">
			...
			<div style="margin-top: 100px;">
				...
				<div class="page-header">
					...
					<h2>Mayors Office <small>Personal Services</small></h2>
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tbody>
						...
						$result = $db->prepare("SELECT * FROM psmmo WHERE year_transact = ? ORDER BY alobs DESC");
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form action="" method="POST">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						<button type="submit" name="submit_edit_ps_mmo" class="btn btn-success">Update</button>
					</div>
				</form>
			</div>
		</div>

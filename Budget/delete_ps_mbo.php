...
$query = "DELETE FROM psmbo WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Budget Office</title>
...
<body>
<label id="accountTitle">Personel Services - MBO - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_mbo.php"  class="active">MBO</a></li>
...
$result = $db->prepare("SELECT * FROM psmbo WHERE year_transact =?");

...
$result = $db->prepare("SELECT sum(total) as total FROM pssb WHERE year_transact = ?");
...
$result->execute([$total, "SB", $_SESSION['budget']]);
/* ------------------------------*/
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM pssb WHERE alobs = ?");
	$result->execute([$rec]);
...
<?PHP
if(isset($_POST['submit_edit_ps_sb'])){
...
$result = $db->prepare("SELECT SUM(total) AS total FROM pssb WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Sangguniang Bayan</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'details_sb_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'edit_sb_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'delete_sb_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					<li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Menu
						...
						<ul class="dropdown-menu">
							<li><a href="aipSB">AIP</a></li>
							<li><a href="export_sb_ps">Export to Excel</a></li>
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mooe_sb_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_sb_all">Capital Outlay</a></li>
							<li><a href="delete_ps_sb">Delete ALOBS</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="psb1">January</a></li>
							<li><a href="psb2">February</a></li>
							<li><a href="psb3">March</a></li>
							<li><a href="psb4">April</a></li>
							<li><a href="psb5">May</a></li>
							<li><a href="psb6">June</a></li>
							<li><a href="psb7">July</a></li>
							<li><a href="psb8">August</a></li>
							<li><a href="psb9">September</a></li>
							<li><a href="psb10">October</a></li>
							<li><a href="psb11">November</a></li>
							<li><a href="psb12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Sangguniang Bayan <small>Personal Services</small></h2>
						...
						<div class="modal-body">
							...
							<form method ="POST" action="" name="form1" autocomplete="off">
								<div class = "form-group">
									<table id="tb1" class="table table-condensed table-hover borderless">
										...
										<tr >
											...
											<td><input type="number"  class="form-control"name="alobs" id="alobs" required min="0" step="any" max=999></td>
											<td><input type="text"  class="form-control"id="claimant" name="claimant" placeholder="Juan Dela Cruz et. al." required></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td class="textc">&nbsp;</td>
											<td><input type="number" step="any" name="tlb" class="form-control"></td>
										</tr>
										<tr>
								...
								<div class="modal-footer">
									...
									<button type="submit" class="btn btn-primary" name="btn_submit_sb">Add Alobs</button>
			...
			<table class="table table-condensed table-striped table-hover table-striped">
				...
				<tbody>
					...
					$query2 = "SELECT * FROM pssb WHERE year_transact = ? ORDER BY alobs DESC";
					$result2 = $db->prepare($query2);
					$result2->execute([$yearTransact]);
					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
							...
							<form action="" method="POST">
								...
								<div class="modal-footer">				
									<button type="button" class="btn btn-default" data-dismiss="modal" data-backdrop="false">Close</button>	
									<button type="submit" class="btn btn-primary" name="submit_edit_ps_sb">Submit</button>		
								</div>
							</form>
						</div>
					</div>

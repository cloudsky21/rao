...
$result = $db->prepare("SELECT SUM(total) AS total FROM sbco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Sangguniang Bayan</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="csb1">January</a></li>
					<li><a href="csb2">February</a></li>
					<li><a href="csb3">March</a></li>
					<li><a href="csb4">April</a></li>
					<li><a href="csb5">May</a></li>
					<li><a href="csb6">June</a></li>
					<li><a href="csb7">July</a></li>
					<li><a href="csb8">August</a></li>
					<li><a href="csb9">September</a></li>
					<li><a href="csb10">October</a></li>
					<li><a href="csb11">November</a></li>
					<li><a href="csb12">December</a></li>
...
<h2>Sangguniang Bayan's Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_sb - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM sbco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM sbco WHERE yearm = ? ");

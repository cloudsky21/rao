...
function get_total_salaries_mmo(){
...
$get_salary = get_total_salaries_mmo();
...
function get_total_yearend_mmo(){
include("config.php");
$year = $_SESSION['budget'];
...
$get_yearend = get_total_yearend_mmo();
...
function get_total_cashgft_mmo(){
include("config.php");
$year = $_SESSION['budget'];
...
$get_cashgft = get_total_cashgft_mmo();
...
function get_total_mid_year_mmo(){
include("config.php");
$year = $_SESSION['budget'];
...
$get_mid_year = get_total_mid_year_mmo();
...
$get_others = get_total_others_mmo();

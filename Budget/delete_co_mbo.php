...
$query = "DELETE FROM mboco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Budget Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_mbo.php"  class="active">MBO</a></li>
...
$result = $db->prepare("SELECT * FROM mboco WHERE yearm =?");

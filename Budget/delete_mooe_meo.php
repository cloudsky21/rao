...
$query = "DELETE FROM meomooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Engineers Office</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Engineers Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_meo.php"  class="active">MEO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_meo_all.php">Personal Services</a>
  <a href="mooe_meo_all.php">Maint. and Other Operating Expenses</a>

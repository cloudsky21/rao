...
?>
			...
			<ul class="list-group">
				...
				if($mm !="0.00"){ echo'<li class="list-group-item">Motor Vehicle Maintenance<span class="badge">'.number_format($mm,2).'</span></li>';} else{} 
				if($tel !="0.00"){ echo'<li class="list-group-item">Telephone / Telegraph and Internet<span class="badge">'.number_format($tel,2).'</span></li>';} else{} 

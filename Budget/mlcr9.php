...
include("cfg.php");
include("functions_mooe_lcr.php");
...
$result = $db->prepare("SELECT SUM(total) AS total FROM lcrmooe WHERE yearm = ? AND month = ?");
...
<title>MOOE Report | Local Civil Registrar</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="mlcr1">January</a></li>
					<li><a href="mlcr2">February</a></li>
					<li><a href="mlcr3">March</a></li>
					<li><a href="mlcr4">April</a></li>
					<li><a href="mlcr5">May</a></li>
					<li><a href="mlcr6">June</a></li>
					<li><a href="mlcr7">July</a></li>
					<li><a href="mlcr8">August</a></li>
					<li><a href="mlcr9">September</a></li>
					<li><a href="mlcr10">October</a></li>
					<li><a href="mlcr11">November</a></li>
					<li><a href="mlcr12">December</a></li>
...
<h2>Local Civil Registrar's Office <br><small>Maintenance and Other Operating Expenses (September <?php echo $_SESSION['budget'] ?>)</small></h2>
...
$result = $db->prepare("SELECT * FROM lcrmooe WHERE yearm = ? AND month = ? ORDER BY alobs DESC");

...
$query = "DELETE FROM psmmo WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mayors Office</title>
...
<body>
<label id="accountTitle">Personel Services - Mayors Office - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			<li><a href="delete_ps_mmo.php"  class="active">MMO</a></li>
...
$result = $db->prepare("SELECT * FROM psmmo WHERE year_transact =?");

...
$isLoaded = check_if_loaded_generalServices_aip();
		if ($isLoaded == '1'){
			...
			header("location: aipPlazaReadonly");
			}
...
<?PHP
	...
	$post_electric =   $_POST['electricity'];
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 01 &#32; 010</td>
			<td><input type="number" id="tev" name="tev" class="form-control" step="any"  required></td>
		</tr>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 04 &#32; 020</td>
			<td><input type="number" id="electricity" name="electricity" class="form-control" step="any"  required></td>
		</tr>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 090</td>
			<td><input type="number" id="gasoline" name="gasoline" class="form-control" step="any"  required></td>
		</tr>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 060</td>
			<td><input type="number" id="vehicle-maintenance" name="vehicle-maintenance" class="form-control" step="any"  required></td>
		</tr>
		...
		<tr>
			<td colspan="4"><button class="btn btn-success form-control" type="submit" name="Update">Submit</button></td>
		</tr>

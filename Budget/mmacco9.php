...
<title>MOOE Report | Mun. Accounting Office</title>
...
<h2>Mun. Accounting Office <br><small>Maintenance and Other Operating Expenses (September <?php echo $_SESSION['budget'] ?>)</small></h2>
...
$result = $db->prepare("SELECT * FROM maccomooe WHERE yearm = ? AND month = ? ORDER BY alobs DESC");

...
$result = $db->prepare("SELECT * FROM meomooe WHERE alobs = ? AND yearm = ?");
...
?>
			...
			<ul class="list-group">
				...
				if($others !="0.00"){ echo'<li class="list-group-item">Other Maintenance and Operating Expenses<span class="badge">'.number_format($others,2).'</span></li>';} else{} 

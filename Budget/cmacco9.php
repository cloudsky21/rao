...
include("cfg.php");
include("functions_co_macco.php");
...
$result = $db->prepare("SELECT SUM(total) AS total FROM maccoco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mun. Accounting Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmacco1">January</a></li>
					<li><a href="cmacco2">February</a></li>
					<li><a href="cmacco3">March</a></li>
					<li><a href="cmacco4">April</a></li>
					<li><a href="cmacco5">May</a></li>
					<li><a href="cmacco6">June</a></li>
					<li><a href="cmacco7">July</a></li>
					<li><a href="cmacco8">August</a></li>
					<li><a href="cmacco9">September</a></li>
					<li><a href="cmacco10">October</a></li>
					<li><a href="cmacco11">November</a></li>
					<li><a href="cmacco12">December</a></li>
...
<h2>Mun. Accounting Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_macco - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM maccoco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM maccoco WHERE yearm = ? ");

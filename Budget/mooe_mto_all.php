...
//numbers	
	...
	$post_post = $_POST['postage'];	
	$post_tel = $_POST['telephone'];	
	$post_fi = $_POST['fi'];	
	$post_aforms = $_POST['aforms'];	
	$post_supplies = $_POST['supplies'];	
	$post_it = $_POST['it'];	
	$post_others = $_POST['others'];
	
	$totalObligation = $post_tev + $post_trainings + $post_post + $post_tel + $post_fi + $post_aforms + $post_supplies + $post_it + $post_others;

	$query = "INSERT INTO mtomooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM mtomooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE mtomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM mtomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Treasurers Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mto_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mto_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mto_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mto_mooe">Export to Excel</a></li>
							<li><a href="personal_services_mto_all">Personal Services</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmto1">January</a></li>
							<li><a href="mmto2">February</a></li>
							<li><a href="mmto3">March</a></li>
							<li><a href="mmto4">April</a></li>
							<li><a href="mmto5">May</a></li>
							<li><a href="mmto6">June</a></li>
							<li><a href="mmto7">July</a></li>
							<li><a href="mmto8">August</a></li>
							<li><a href="mmto9">September</a></li>
							<li><a href="mmto10">October</a></li>
							<li><a href="mmto11">November</a></li>
							<li><a href="mmto12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td><input class="form-control" type="number" step="any" name="tev" min=0></td>
							</tr>
							<tr>
								<td>Training &amp; Seminar Expenses</td>
								<td class="help-block">02 &nbsp; 02 &nbsp;	010</td>
								<td><input class="form-control" type="number" step="any" name="trainings" min=0></td>
							</tr>
							<tr>
								<td>Postage and Deliveries</td>
								<td class="help-block">02 &nbsp; 05 &nbsp;	010</td>
								<td><input class="form-control" type="number" step="any" name="postage" min=0></td>
							</tr>
							
							<tr>
								<td>Telephone / Telegraph and Internet</td>
								<td class="help-block">02 &nbsp; 05 &nbsp; 030</td>
								<td><input class="form-control" type="number" step="any" name="telephone" min=0></td>
							</tr>
							
							<tr>
								<td>Fedility Bond Premium & Insurance Premium</td>
								<td class="help-block">02 &nbsp; 16 &nbsp; 020</td>
								<td><input class="form-control" type="number" step="any" name="fi" min=0></td>
							</tr>
							
							<tr>
								<td>Accountable Forms Expenses</td>
								<td class="help-block">02 &nbsp; 03 &nbsp; 020</td>
								<td><input class="form-control" type="number" step="any" name="aforms" min=0></td>
							</tr>
							
							<tr>
								<td>Office Supplies</td>
								<td class="help-block">02 &nbsp; 03 &nbsp;	010</td>
								<td><input class="form-control" type="number" step="any" name="supplies" min=0></td>
							</tr>
							<tr>
								<td>Repairs and Maintenance <br> - IT Equipment and Software</td>
								<td class="help-block">02 &nbsp; 13 &nbsp; 050</td>
								<td><input class="form-control" type="number" step="any" name="it" min=0></td>
							</tr>
							<tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Treasurers Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM mtomooe WHERE yearm = ?");

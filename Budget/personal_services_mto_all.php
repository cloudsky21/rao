...
$result = $db->prepare("SELECT sum(total) as total FROM psmto WHERE year_transact = ?");
...
$result->execute([$total, "MTO", $_SESSION['budget']]);
...
//numbers	
	...
	$totalObligation = $post_salary +  	$post_pera +$post_ra + $post_ta + $post_cloth+$post_yend+$post_gft+$post_mid+$post_pib+$post_gsis+$post_hdmf+$post_care+$post_ecc + $post_tlb + $post_others;

	$query = "INSERT INTO psmto (
	year_transact, 
	month_transact, 
	day_transact, 
	alobs, 
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmto WHERE alobs = ?");
	$result->execute([$rec]);
...
<head>
	...
	<title>PS | Municipal Treasurers Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mto_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mto_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mto_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mto_ps">Export to Excel</a></li>
							<li><a href="mooe_mto_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_mto_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmto1">January</a></li>
							<li><a href="pmto2">February</a></li>
							<li><a href="pmto3">March</a></li>
							<li><a href="pmto4">April</a></li>
							<li><a href="pmto5">May</a></li>
							<li><a href="pmto6">June</a></li>
							<li><a href="pmto7">July</a></li>
							<li><a href="pmto8">August</a></li>
							<li><a href="pmto9">September</a></li>
							<li><a href="pmto10">October</a></li>
							<li><a href="pmto11">November</a></li>
							<li><a href="pmto12">December</a></li>
		...
		<div class="container">
			...
			<div style="margin-top: 100px;">
				...
				<div class="page-header">
					...
					<h2>Mun. Treasurers Office <small>Personal Services</small></h2>
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tbody>
						...
						$result = $db->prepare("SELECT * FROM psmto WHERE year_transact = ? ORDER BY alobs DESC");

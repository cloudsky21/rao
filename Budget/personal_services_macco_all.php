...
include("cfg.php");
include("functions_ps_macco.php");
...
$result = $db->prepare("SELECT sum(total) as total FROM psmacco WHERE year_transact = ?");
...
$result->execute([$total, "MACCO", $_SESSION['budget']]);
...
//numbers	
	...
	$rs = $db->prepare("INSERT INTO psmacco (
		year_transact, 
		month_transact, 
		day_transact, 
		alobs, 
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmacco WHERE alobs = ?");
	$result->execute([$rec]);
...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmacco WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Municipal Accounting Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_macco_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_macco_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_macco_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_macco_ps">Export to Excel</a></li>
							<li><a href="mooe_macco_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_macco_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmacco1">January</a></li>
							<li><a href="pmacco2">February</a></li>
							<li><a href="pmacco3">March</a></li>
							<li><a href="pmacco4">April</a></li>
							<li><a href="pmacco5">May</a></li>
							<li><a href="pmacco6">June</a></li>
							<li><a href="pmacco7">July</a></li>
							<li><a href="pmacco8">August</a></li>
							<li><a href="pmacco9">September</a></li>
							<li><a href="pmacco10">October</a></li>
							<li><a href="pmacco11">November</a></li>
							<li><a href="pmacco12">December</a></li>
		...
		<div class="container">
			...
			<div style="margin-top: 100px;">
				...
				<div class="page-header">
					...
					<h2>Mun. Accounting Office <small>Personal Services</small></h2>
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tbody>
						...
						$result = $db->prepare("SELECT * FROM psmacco WHERE year_transact = ? ORDER BY alobs DESC");
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form action="" method="POST">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
						<button type="submit" name="submit_edit_ps" class="btn btn-success">Update</button>
					</div>
				</form>
			</div>
		</div>

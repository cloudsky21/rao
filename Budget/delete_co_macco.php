...
$query = "DELETE FROM maccoco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Accounting Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_macco.php"  class="active">MACCO</a></li>
...
$result = $db->prepare("SELECT * FROM maccoco WHERE yearm =?");

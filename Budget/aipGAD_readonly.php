...
<thead>
	...
	<th>Balance<br>&#40;3&#41;</th>
		...
		<?PHP 
		$tablename = "gad_list_".$_SESSION['budget']; //gad_list_(current Year) table
		...
		foreach($edfCyTbl as $list){
			...
			$table2 = "gad".$_SESSION['budget']; //gad_CY table
			$codelist = $list['code'];

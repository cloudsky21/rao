...
$query = "DELETE FROM mtoco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Treasurers Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_mto.php"  class="active">MTO</a></li>
...
$result = $db->prepare("SELECT * FROM mtoco WHERE yearm =?");

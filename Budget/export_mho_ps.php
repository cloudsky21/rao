...
$sqlExcel = "SELECT * FROM psmho WHERE year_transact = '$yy'";
...
$objPHPExcel->getActiveSheet()->setTitle('PSMHO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('S13','Health Workers Benefits');
...
while ($row = mysqli_fetch_assoc($result))
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('S'.$rowCount,$row['hwb']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow, get_total_hwb());
...
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow1, get_hwb_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow2, get_aip_hwb());

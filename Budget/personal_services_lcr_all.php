...
$result = $db->prepare("SELECT sum(total) as total FROM pslcr WHERE year_transact = ?");
...
$result->execute([$total, "LCR", $_SESSION['budget']]);
/* ------------------------------*/
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM pslcr WHERE alobs = ?");
	$result->execute([$rec]);
...
//numbers	
	...
	$result =$db->prepare("INSERT INTO pslcr (
		year_transact, 
		month_transact, 
		day_transact, 
		alobs, 
...
<?PHP
if(isset($_POST['submit_edit_ps_lcr'])){
...
$result = $db->prepare("SELECT SUM(total) AS total FROM pslcr WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Local Civil Registrar</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_lcr_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_lcr_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_lcr_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					<li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Menu
						...
						<ul class="dropdown-menu">
							<li><a href="aipLCR">AIP</a></li>
							<li><a href="export_lcr_ps">Export to Excel</a></li>
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mooe_lcr_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_lcr_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="plcr1">January</a></li>
							<li><a href="plcr2">February</a></li>
							<li><a href="plcr3">March</a></li>
							<li><a href="plcr4">April</a></li>
							<li><a href="plcr5">May</a></li>
							<li><a href="plcr6">June</a></li>
							<li><a href="plcr7">July</a></li>
							<li><a href="plcr8">August</a></li>
							<li><a href="plcr9">September</a></li>
							<li><a href="plcr10">October</a></li>
							<li><a href="plcr11">November</a></li>
							<li><a href="plcr12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Local Civil Registrar's Office <small>Personal Services</small></h2>
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<form action="" method="POST">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								<button type="submit" name="submit_edit_ps_lcr" class="btn btn-success">Update</button>
							</div>
						</form>
					</div>
				</div>
			...
			<table id="tb2" class="table table-condensed table-striped table-hover">
				<thead>
					<tr>
						<th>DATE</th>
				...
				<tbody>
					...
					$query2 = "SELECT * FROM pslcr WHERE year_transact = ? ORDER BY alobs DESC";

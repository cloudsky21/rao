...
<head>
	...
	<title>PS Report | Municipal Budget Office</title>
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="personal_services_mbo_all">Personal Services</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Mun. Budget's Office <br><small>Personal Services (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
				...
				<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mbo,2); ?></span></li>
				<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mbo - $ps_september_total,2); ?></span></li>
			...
			<table class="table table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM psmbo WHERE year_transact = ? AND month_transact = ? ORDER BY alobs DESC");

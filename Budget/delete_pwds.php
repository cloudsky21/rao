...
$query = "DELETE FROM pwds WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete 1&#37; Persons With Disability</title>
...
<body>
<label id="accountTitle">1&#37; Persons With Disability
</label>
<div id="container">
	<div class="wrap">
		<ul>
			
			<li><a href="delete_rao20.php">20&#37; EDF</a></li>
			<li><a href="delete_gad.php">GAD</a></li>
			<li><a href="delete_mdr.php">MDR</a></li>
			<li><a href="delete_scs.php">1&#37; SC</a></li>
			<li><a href="delete_pwds.php" class="active">1&#37; PWDs</a></li>
			<li><a href="delete_1iralcpc.php">1&#37; IRA & LCPC</a></li>
</ul>
  </div>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="pwds.php">RAO 1&#37; Persons With Disability</a>
...
$result = $db->prepare("SELECT * FROM pwds WHERE yearm =?");

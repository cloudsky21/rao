...
<title>RAO | Disaster Risk Management</title>
...
$(document).ready(function(){
    $('#infoModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'details_rmdr.php', //Here you will fetch records 
...
$(document).ready(function(){
    $('#editModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'edit_rmdr.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
...
$(document).ready(function(){
    $('#deleteModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'delete_rmdr.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
            }
	...
	<ul class="nav navbar-nav">
      ...
      <li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Registry Allotments and Obligations (RAO)
	    ...
	    <ul class="dropdown-menu">
		 ...
		 <li><a href="continuing_mmo_all">Continuing Program</a></li>
		 <li><a href="sef">SEF</a></li>
							...
							<div class="col-sm-8">
								<select name="rao" id="rao" class="form-control">
										<?PHP 
											...
											$rao_list = "mdr_list_".$_SESSION['budget'];
															...
															<div class="container">
																<div style="margin-top: 100px;">
																	<div class="page-header">
																		<h2>5% Municipal Disaster Risk</h2>
																	</div>

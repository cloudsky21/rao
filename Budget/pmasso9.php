...
<head>
	...
	<title>PS Report | Mun. Assessors Office</title>
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_masso_ps">Export to Excel</a></li>
							<li><a href="personal_services_masso_all">Personal Services</a></li>
							<li><a href="mooe_masso_all">Maint. and Other Operating Expenses</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Mun. Assessors Office <br><small>Personal Services (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
				...
				<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_masso,2); ?></span></li>
				<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_masso - $ps_september_total,2); ?></span></li>
			...
			<table class="table table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM psmasso WHERE year_transact = ? AND month_transact = ? ORDER BY alobs DESC");

...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$total_mooe = $post_tev +  $post_training +  $post_office_supplies + $post_other_maintenance;
	...
	$query = "UPDATE aip SET salaries = ?, PERA = ?, RA = ?, TA = ?, clothing_allowance = ?, year_end = ?, cash_gift = ?, 
							 ...
							 tev = ?, training_seminars = ?, office_supplies = ?, others = ?, total_mooe = ?, co = ?, total_co = ? WHERE departments = 'MBO' && Year = ?  ";
	...
	$result->execute([$post_salary, $post_pera, $post_ra, $post_ta, $post_clothing, $post_year_end, $post_cash_gift, $post_mid_year, $post_pib, $post_gsis, $post_hdmf, $post_philHealth, $post_ecc, $post_opb, $total_ps, $post_tev, $post_training, $post_office_supplies, $post_other_maintenance, $total_mooe, $post_capital_outlay, $total_coe, $budy]);
...
<title>AIP | Municipal Budgets Office</title>
</head>
<body>
...
<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>OFFICE OF THE MUNICIPAL BUDGET OFFICER</strong></label>  
...
<thead>
	...
	<th style="text-align: center;">Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="office-supplies" name="office-supplies" class="form-control" value="'.$off.'" tabindex="17" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="telephone" name="telephone" class="form-control" value="'.$phonegraph.'" tabindex="18" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" class="form-control" value="'.$ot.'" tabindex="19" step="any"></td>';

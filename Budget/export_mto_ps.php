...
$sqlExcel = "SELECT * FROM psmto WHERE year_transact = '$yy'";
...
$objPHPExcel->getActiveSheet()->setTitle('PSMTO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('S13','Terminal Leave');
...
while ($row = mysqli_fetch_assoc($result))
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('S'.$rowCount,$row['terminal_benefits']);

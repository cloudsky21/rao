...
$table = "sef".$_SESSION['budget'];
try{
refresh_all();
}
catch(Exception $e)
{
	echo ("Setup AIP for Special Education Fund. This page will be redirected.. in 3 seconds");
	header('Refresh: 3; url=aipsefsetup.php');
	exit();
...
<title>Report | Special Education Fund</title>
     ...
     <li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Registry Allotment and Obligations (RAO)
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_sef.php">Export to Excel</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
	  ...
	  <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="sef1.php">January</a></li>
					<li><a href="sef2.php">February</a></li>
					<li><a href="sef3.php">March</a></li>
					<li><a href="sef4.php">April</a></li>
					<li><a href="sef5.php">May</a></li>
					<li><a href="sef6.php">June</a></li>
					<li><a href="sef7.php">July</a></li>
					<li><a href="sef8.php">August</a></li>
					<li><a href="sef9.php">September</a></li>
					<li><a href="sef10.php">October</a></li>
					<li><a href="sef11.php">November</a></li>
					<li><a href="sef12.php">December</a></li>
...
<h2>Special Education Fund <br><small>September <?php echo $_SESSION['budget'] ?></small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_sef,2); ?></span></li>
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_sef - $nt_9, 2); ?></span></li>
			...
			<ul class="list-group col-sm-8">
				<li class="list-group-item"><label class="list-group-item-heading">Total: </label><p class="list-group-item-text"><?PHP echo number_format($nt_9,2); ?></p></li>

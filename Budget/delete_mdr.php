...
$query = "DELETE FROM mdr WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete 5&#37; Municipal Disaster Risk</title>
...
<body>
<label id="accountTitle">5&#37; Municipal Disaster Risk
</label>
<div id="container">
	<div class="wrap">
		<ul>
			
			<li><a href="delete_rao20">20&#37; EDF</a></li>
			<li><a href="delete_gad">GAD</a></li>
			<li><a href="delete_mdr" class="active">MDR</a></li>
			<li><a href="delete_scs">1% SC</a></li>
			<li><a href="delete_pwds">1% PWDs</a></li>
			<li><a href="delete_1iralcpc">1% IRA & LCPC</a></li>
</ul>
  </div>
...
$result = $db->prepare("SELECT * FROM mdr WHERE yearm =?");

...
$query = "DELETE FROM lcrco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Local Civil Registrars Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_lcr.php"  class="active">LCR</a></li>
...
$result = $db->prepare("SELECT * FROM lcrco WHERE yearm =?");

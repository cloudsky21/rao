...
<head>
	...
	<title>PS Report | Mun. Planning and Development Office</title>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Municipal Planning and Development Office <br><small>Personal Services (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
				...
				<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mpdo,2); ?></span></li>
				<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mpdo - $ps_september_total,2); ?></span></li>
			...
			<table class="table table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM psmpdo WHERE year_transact = ? AND month_transact = ? ORDER BY alobs DESC");

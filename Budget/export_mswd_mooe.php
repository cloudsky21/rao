...
$sqlExcel = "SELECT * FROM mswdmooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->setTitle('MOOEMSWD');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Social Welfare Office');
...
$objPHPExcel->getActiveSheet()->SetCellValue('J13','Grants &amp; Donations (AICS)');
$objPHPExcel->getActiveSheet()->SetCellValue('J14','05   02   99   080');
...
foreach ($result as $row)
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount,$row['aics']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_aics());
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_aics_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow2, get_aip_aics());

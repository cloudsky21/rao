...
$query = "DELETE FROM mbomooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Budget Office</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Budget Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_mbo.php"  class="active">MBO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mbo_all.php">Personal Services</a>
  <a href="mooe_mbo_all.php">Maint. and Other Operating Expenses</a>

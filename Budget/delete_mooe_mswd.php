...
$query = "DELETE FROM mswdmooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Social Welfare and Development</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Social Welfare and Development
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_mswd.php"  class="active">MSWD</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mswd_all.php">Personal Services</a>
  <a href="mooe_mswd_all.php">Maint. and Other Operating Expenses</a>

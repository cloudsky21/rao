...
<h2>Local Civil Registrar's Office <br><small>Capital Outlay (June <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_lcr - $total_6,2); ?></span></li>

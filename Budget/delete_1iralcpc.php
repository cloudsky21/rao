...
$query = "DELETE FROM iralcpc WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">1&#37; IRA-LCPC
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mdr">MDR</a></li>
			<li><a href="delete_scs">1% SC</a></li>
			<li><a href="delete_pwds">1% PWDs</a></li>
			<li><a href="delete_1iralcpc" class="active">1% IRA & LCPC</a></li>
</ul>
  </div>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="iralcpc">RAO 1&#37; IRA-LCPC</a>
...
$result = $db->prepare("SELECT * FROM iralcpc WHERE yearm =?");

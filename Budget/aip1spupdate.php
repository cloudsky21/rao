...
try
{
		$tbl_list = "1sp_list_".$_SESSION['budget']; 
		...
		//Delete the column from r1sp_CY
		$tbl_r20edf = "r1sp".$_SESSION['budget'];
		$alter_table = $db->prepare("ALTER TABLE `$tbl_r20edf` DROP `$get_recorded`");
		$alter_table->execute();
...
try
{
	...
	$get_budget = "1sp_list_".$_SESSION['budget'];
	...
	$tablename_20 = "1sp".$_SESSION['budget'];
...
$get_longname = htmlentities($_POST['longname-edit']);
	...
	if($_POST['sector'] == "GENERAL PUBLIC SERVICES"){
		...
		$tb_list1 = "1sp_list_".$_SESSION['budget'];
		...
		$tb_list2 = "1sp_list_".$_SESSION['budget'];
...
<title>AIP | Senior Citizen & Persons With Disability</title>
...
$(document).ready(function(){
    $('#edit').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'editaip1sp.php', //Here you will fetch records 
...
$(document).ready(function(){
    $('#delete').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'deleteaip1sp.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
...
<nav class="navbar navbar-default navbar-fixed-top">
	...
	<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings
		...
		<ul class="dropdown-menu">
			...
			<li><a href="aip1sp">Back-to-AIP <strong>SC/PWDs</strong></a></li>
...
<div class="container">
	<div style="margin-top: 100px;">
		...
		<div class="page-header">
			<h2>Update Table of  1% Senior Citizen & Persons With Disability</h2>
		</div>
  

			
				<label>Table: <STRONG>Senior Citizen & Persons With Disability (<?PHP echo $_SESSION['budget'] ?>)</strong></label>&nbsp; &nbsp; <button class="btn btn-default btn-xs" data-toggle="modal" data-target="#addProgram"><span class="glyphicon glyphicon-plus"></span></button>  
						...
						<table class="table table-condensed table-hover">
							...
							<tbody>
								<?PHP 
										...
										$current_year = "1sp_list_".$_SESSION['budget'];

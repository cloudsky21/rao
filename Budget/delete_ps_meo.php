...
$query = "DELETE FROM psmeo WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Enginneering Office</title>
...
<body>
<label id="accountTitle">Personel Services - MEO - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_meo.php"  class="active">MEO</a></li>

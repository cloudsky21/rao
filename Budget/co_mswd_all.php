...
$result = $db->prepare("INSERT INTO mswdco (yearm, month, day, alobs, claimant, description, capital_outlay, total) VALUES (?, ?, ?, ?, ?, ?, ?,?)");
...
$result = $db->prepare("DELETE FROM mswdco WHERE alobs = ?");
...
$result = $db->prepare("UPDATE mswdco SET 
yearm=?, 
month=?, 
day=?, 
alobs=?, 
...
<title>CO |Mun. Social Welfare and Development Office</title>
...
$(document).ready(function(){
    $('#infoModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'details_mswd_co.php', //Here you will fetch records 
...
$(document).ready(function(){
    $('#editModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'edit_mswd_co.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
...
$(document).ready(function(){
    $('#deleteModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'delete_mswd_co.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
            }
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_mswd_co">Export to Excel</a></li>
			<li><a href="personal_services_mswd_all">Personal Services</a></li>
			<li><a href="mooe_mswd_all">Maintenance and Other Operating Expenses</a></li>
	...
	<?php if($getlock == '0'){ echo '<li><a href="#"  data-toggle="modal" data-target="#addObl"  data-backdrop="static" data-keyboard="false"><span class="glyphicon glyphicon-plus"></span></a></li>'; } else {} ?>
	 ...
	 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					</li><li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span>&nbsp;<span class="caret"></span></a>
		<ul class="dropdown-menu">
															...
															<div class="container">
																<div style="margin-top: 100px;">
																	<div class="page-header">
																		<h2>Mun. Social Welfare and Development Office <small>Capital Outlay</small></h2>
																	</div>
...
$result = $db->prepare("SELECT * FROM mswdco WHERE yearm = ? ORDER BY alobs DESC");

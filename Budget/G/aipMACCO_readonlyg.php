...
<div id="mySidenav" class="sidenav">
  ...
  <a href="mooe_macco_all.php">Maint. &amp; Other Operating Expenses</a>
...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="auditing" name="auditing" class="w3-input" value="'.$aud.'" tabindex="19" step="any"></td>';
			echo '<td><input type="text" class="w2-input" readonly value="'.number_format(select_aip_auditing_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" class="w3-input" value="'.$ot.'" tabindex="20" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="w3-input" value="'.$coo.'" tabindex="21" step="any"></td>';

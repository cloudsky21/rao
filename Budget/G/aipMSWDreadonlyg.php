...
mysqli_set_charset($db,"utf8");
	...
	$post_subsistence = mysqli_real_escape_string($db, $_POST['subsistence-allowance']);
	...
	$post_aics = mysqli_real_escape_string($db, $_POST['aics']);
	...
	total_mooe = ?, 
	co = ?, 
	total_co = ? WHERE departments = 'MSWD' && Year = ?  ";
...
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="aipMSWD.php"  class="active">MSWD</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mswd_all.php">Personnel Services</a>
  <a href="mooe_mswd_all.php">Maint. &amp; Other Operating Expenses</a>
  <a href="co_mswd_all.php">Capital Outlay</a>
...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<?PHP
			$subs = floatval(select_aip_sub());
			echo '<td>'.number_format($subs,2).'</td>';
			echo '<td><input type="number" id="subsistence-allowance" name="subsistence-allowance" class="w3-input" value="'.$subs.'" tabindex="14" step="any"></td>';
			echo '<td><input type="text" class="w2-input" readonly value="'.number_format(select_aip_sub_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="office-supplies" name="office-supplies" class="w3-input" value="'.$off.'" tabindex="19" step="any"></td>';
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 99 &#32; 080</td>
			<?PHP
			$aicss = floatval(select_aip_aics());
			echo '<td>'.number_format($aicss,2).'</td>';
			echo '<td><input type="number" id="aics" name="aics" class="w3-input" value="'.$aicss.'" tabindex="20" step="any"></td>';
			echo '<td><input type="text" class="w2-input" readonly value="'.number_format(select_aip_aics_bal(),2).'"></td>';
			?>
		</tr>

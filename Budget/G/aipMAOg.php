...
$isLoaded = check_if_loaded_mao_aip();
		if ($isLoaded == '1'){
	
			header("location: aipMAOreadonly.php");
			}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$dept_code = "MAO";
	$dept_head = "ZOSIMO G. ADVINCULA";
	$dept_name = "Municipal Agriculturists Office";
	...
	$post_equip = mysqli_real_escape_string($db, $_POST['equipment']);
	...
	$total_mooe = $post_tev +  $post_training + $post_telephone + $post_office_supplies + $post_equip;
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 13 &#32; 050</td>
			<td><input type="number" id="equipment" name="equipment" class="w3-input" step="any" min=0  value="0.00"></td>

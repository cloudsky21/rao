...
mysqli_set_charset($db,"utf8");
	...
	$total_mooe = $post_tev +  $post_training +  + $post_telephone + $post_office_supplies + $post_equipment;
	...
	total_mooe = ?, 
	co = ?, 
	total_co = ? WHERE departments = 'MAO' && Year = ?  ";
	
	if ($result = mysqli_prepare($db, $query)){
		
	mysqli_stmt_bind_param($result,"ssssssssssssssssssssssss",
	$post_salary, 
	$post_pera, 
	$post_ra, 
	$post_ta, 
...
<title>AIP | Municipal Agriculturists Office</title>
<style>
html, body {
...
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="aipMAO.php"  class="active">MAO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mao_all.php">Personnel Services</a>
  <a href="mooe_mao_all.php">Maint. &amp; Other Operating Expenses</a>
  <a href="co_mao_all.php">Capital Outlay</a>
...
<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>OFFICE OF THE MUNICIPAL AGRICULTURIST</strong></label>  
<table>
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="telephone" name="telephone" class="w3-input" value="'.$phonegraph.'" tabindex="18" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="equipment" name="equipment" class="w3-input" step="any" value="'.$ofequip.'"></td>';

...
$isLoaded = check_if_loaded_mpdo_aip();
		if ($isLoaded == '1'){
	
			header("location: aipMPDO_readonly.php");
			}
...
mysqli_set_charset($db,"utf8");
	...
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, salaries, PERA, RA, TA, clothing_allowance, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, other_allowance_bonuses, total_ps,
...
<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>OFFICE OF THE MUN. PLANNING &amp; DEVELOPMENT COORDINATOR</strong></label>  
<table>
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="oba" name="oba" class="w3-input" step="any" value="0.00"></td>

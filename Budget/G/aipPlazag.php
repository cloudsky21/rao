...
$isLoaded = check_if_loaded_generalServices_aip();
		if ($isLoaded == '1'){
	
			header("location: aipPlazaReadonly.php");
			}
...
<?PHP
	...
	$post_electric = mysqli_real_escape_string($db, $_POST['electricity']);
	...
	$total_mooe = $post_tev  + $post_office_supplies + $post_water  + $post_electric + $post_gasoline + $post_vehicle;
	...
	mysqli_stmt_bind_param($result,"ssssssssssssssssssssssssss", 
	$budy, 
	$dept_code, 
	$dept_name, 
	$dept_head, 
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32;01&#32;01&#32;010</td>
			<td><input type="number" id="salaries" name="salaries" class="w3-input" step="any" value="0.00" required></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32;01&#32;02&#32;010</td>
			<td><input type="number" id="PERA" name="PERA" class="w3-input" step="any" value="0.00" required></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 02 &#32; 040</td>
			<td><input type="number" id="clothing_allowance" name="clothing_allowance" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 02 &#32; 140</td>
			<td><input type="number" id="year_end" name="year_end" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 02 &#32; 150</td>
			<td><input type="number" id="cash_gift" name="cash_gift" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 02 &#32; 990-1</td>
			<td><input type="number" id="mid_year" name="mid_year" class="w3-input" step="any" value="0.00" required></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 02 &#32; 080</td>
			<td><input type="number" id="pib" name="pib" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 03 &#32; 010</td>
			<td><input type="number" id="gsis" name="gsis" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 03 &#32; 020</td>
			<td><input type="number" id="hdmf" name="hdmf" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 03 &#32; 030</td>
			<td><input type="number" id="philHealth" name="philHealth" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5 &#32; 01 &#32; 03 &#32; 040</td>
			<td><input type="number" id="ecc" name="ecc" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><input type="number" id="opb" name="opb" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 01 &#32; 010</td>
			<td><input type="number" id="tev" name="tev" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 03 &#32; 010</td>
			<td><input type="number" id="office-supplies" name="office-supplies" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 04 &#32; 010</td>
			<td><input type="number" id="water" name="water" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 04 &#32; 020</td>
			<td><input type="number" id="electricity" name="electricity" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 13 &#32; 090</td>
			<td><input type="number" id="gasoline" name="gasoline" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 13 &#32; 060</td>
			<td><input type="number" id="vehicle-maintenance" name="vehicle-maintenance" class="w3-input" step="any" value="0.00" required></td>
		</tr>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>1&#32;07&#32;05&#32;020</td>
			<td><input type="number" id="capital-outlay" name="capital-outlay" class="w3-input" step="any" value="0.00" required></td>
		</tr>

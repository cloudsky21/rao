...
$isLoaded = check_if_loaded_mbe_aip();
		if ($isLoaded == '1'){
			...
			header("location: aipMarketreadonly.php");
			}
...
<?PHP
	...
	$post_aca = mysqli_real_escape_string($db, $_POST['ACA']);
	...
	$post_slaught = mysqli_real_escape_string($db,$_POST['market-slaughter']);
	...
	mysqli_stmt_bind_param($result,"sssssssssssssssssssssssss", 
	$budy, 
	$dept_code, 
	$dept_name, 
	$dept_head, 
...
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="aipMarket.php"  class="active">MARKET</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mbe_all.php">Personnel Services</a>
  <a href="mooe_mbe_all.php">Maint. &amp; Other Operating Expenses</a>
  <a href="co_mbe_all.php">Capital Outlay</a>
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32;01&#32;02&#32;020</td>
			<td><input type="number" id="ACA" name="ACA" class="w3-input" step="any" value="0.00" required></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 02 &#32; 010</td>
			<td><input type="number" id="training" name="training" class="w3-input" step="any" value="0.00" required></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>5&#32; 02 &#32; 13 &#32; 040</td>
			<td><input type="number" id="market-slaughter" name="market-slaughter" class="w3-input" step="any" value="0.00" required></td>

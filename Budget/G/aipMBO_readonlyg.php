...
mysqli_set_charset($db,"utf8");
	...
	mysqli_stmt_bind_param($result,"sssssssssssssssssssssss",$post_salary, $post_pera, $post_ra, $post_ta, $post_clothing, $post_year_end, $post_cash_gift, $post_mid_year, $post_pib, $post_gsis, $post_hdmf, $post_philHealth, $post_ecc, $post_opb, $total_ps, $post_tev, $post_training, $post_office_supplies, $post_other_maintenance, $total_mooe, $post_capital_outlay, $total_coe, $budy);
...
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="aipMBO.php"  class="active">MBO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mbo_all.php">Personnel Services</a>
  <a href="mooe_mbo_all.php">Maint. &amp; Other Operating Expenses</a>
  <a href="co_mbo_all.php">Capital Outlay</a>
...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="office-supplies" name="office-supplies" class="w3-input" value="'.$off.'" tabindex="17" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" class="w3-input" value="'.$ot.'" tabindex="19" step="any"></td>';

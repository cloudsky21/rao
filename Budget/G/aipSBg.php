...
$isLoaded = check_if_loaded_sb_aip();
if ($isLoaded == '1'){
	
	header("location: aipSB_readonly.php");
}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	// $post_total_personal_services = mysqli_real_escape_string($db, $_POST['total-personal-services']);
	...
	$post_ads = mysqli_real_escape_string($db,$_POST['ads']);
	...
	$total_ps = $post_salary + $post_pera + $post_ra + $post_ta + $post_clothing + $post_year_end + $post_cash_gift + $post_mid_year + $post_pib + $post_gsis + $post_hdmf + $post_philHealth + $post_ecc + $post_personel + $post_tl; 
	$total_mooe = $post_tev +  $post_training +  $post_telephone + $post_postage + $post_fedility_premium + $post_office_supplies + $post_ads + $post_other_maintenance;
	$total_coe = $post_capital_outlay + 0;
	
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, salaries, PERA, RA, TA, clothing_allowance, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, other_personal, total_ps,
								tev, training_seminars, telephone_telegraph, postage, fidelity_bond, office_supplies, advertising_expenses, others, total_mooe, terminal_leave, co, total_co) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	
	if ($result = mysqli_prepare($db, $query)){
		
	mysqli_stmt_bind_param($result,"sssssssssssssssssssssssssssssss", $budy, $dept_code, $dept_name, $dept_head, $post_salary, $post_pera, $post_ra, $post_ta, $post_clothing, $post_year_end, $post_cash_gift, $post_mid_year, $post_pib, $post_gsis, $post_hdmf, $post_philHealth, $post_ecc, $post_personel, $total_ps, $post_tev, $post_training, $post_telephone, $post_postage, $post_fedility_premium, $post_office_supplies, $post_ads, $post_other_maintenance, $total_mooe, $post_tl, $post_capital_outlay, $total_coe);
...
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="aipSB.php" class="active">SB</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_sb_all.php">Personnel Services</a>
  <a href="mooe_sb_all.php">Maint. &amp; Other Operating Expenses</a>
  <a href="co_sb_all.php">Capital Outlay</a>
...
<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>OFFICE OF THE SANGGUNIANG BAYAN</strong></label>  
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			<td>PERA</td>
			<td>5&#32;01&#32;02&#32;010</td>
			<td><input type="number" id="PERA" name="PERA" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			<td>RA</td>
			<td>5&#32;01&#32;02&#32;020</td>
			<td><input type="number" id="RA" name="RA" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			<td>TA</td>
			<td>5 &#32; 01 &#32; 02 &#32; 030</td>
			<td><input type="number" id="TA" name="TA" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 040</td>
			<td><input type="number" id="clothing_allowance" name="clothing_allowance" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 140</td>
			<td><input type="number" id="year_end" name="year_end" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			<td>Cash Gift</td>
			<td>5 &#32; 01 &#32; 02 &#32; 150</td>
			<td><input type="number" id="cash_gift" name="cash_gift" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 990-1</td>
			<td><input type="number" id="mid_year" name="mid_year" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			<td>PIB</td>
			<td>5 &#32; 01 &#32; 02 &#32; 080</td>
			<td><input type="number" id="pib" name="pib" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 010</td>
			<td><input type="number" id="gsis" name="gsis" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 020</td>
			<td><input type="number" id="hdmf" name="hdmf" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 030</td>
			<td><input type="number" id="philHealth" name="philHealth" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 040</td>
			<td><input type="number" id="ecc" name="ecc" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="terminal-leave" name="terminal-leave" class="w3-input"  step="any" min=0 value="0.00"></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="personel" name="personel" class="w3-input"  step="any" min=0 value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 01 &#32; 010</td>
			<td><input type="number" id="tev" name="tev" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 02 &#32; 010</td>
			<td><input type="number" id="training" name="training" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 05 &#32; 030</td>
			<td><input type="number" id="telephone" name="telephone" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 05 &#32; 010</td>
			<td><input type="number" id="postage" name="postage" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 16 &#32; 020</td>
			<td><input type="number" id="fedility-premium" name="fedility-premium" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 03 &#32; 010</td>
			<td><input type="number" id="office-supplies" name="office-supplies" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 99 &#32; 010</td>
			<td><input type="number" id="ads" name="ads" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 99 &#32; 990</td>
			<td><input type="number" id="other-maintenance" name="other-maintenance" class="w3-input" value="0.00" step="any"></td>
		...
		<tr>
			...
			<td>1&#32;07&#32;05&#32;020</td>
			<td><input type="number" id="capital-outlay" name="capital-outlay" class="w3-input" value="0.00"></td>

...
$isLoaded = check_if_loaded_mmo_aip();
		if ($isLoaded == '1'){
	
			header("location: aipMMO_readonly.php");
			}
...
if(isset($_POST['submit'])){
	...
	$dept_code = "MMO";
	$dept_head = "HON. ERWIN C. OCAÑA";
	$dept_name = "Mayors Office";
	...
	$total_ps = $post_salary + $post_pera + $post_ra + $post_ta + $post_clothing + $post_honoraria + $post_year_end + $post_cash_gift + $post_mid_year + $post_pib + $post_gsis + $post_hdmf + $post_philHealth + $post_ecc + $post_personel + $post_tl; 
	...
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, salaries, PERA, RA, TA, clothing_allowance, honoraria, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, other_personal, total_ps,
								tev, training_seminars, telephone_telegraph, postage, insurance_premium, fidelity_bond, office_supplies, gasoline, motor_vehicle_maint, office_equip_maint, confidential_intel_maint, others, total_mooe, terminal_leave, co, total_co) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	
	if ($result = mysqli_prepare($db, $query)){
		
	mysqli_stmt_bind_param($result,"ssssssssssssssssssssssssssssssssssss", $budy, $dept_code, $dept_name, $dept_head, $post_salary, $post_pera, $post_ra, $post_ta, $post_clothing, $post_honoraria, $post_year_end, $post_cash_gift, $post_mid_year, $post_pib, $post_gsis, $post_hdmf, $post_philHealth, $post_ecc, $post_personel, $total_ps, $post_tev, $post_training, $post_telephone, $post_postage, $post_insurance_premium, $post_fedility_premium, $post_office_supplies, $post_gasoline, $post_motor_vehicle, $post_equipment, $post_confidential, $post_other_maintenance, $total_mooe, $post_tl, $post_capital_outlay, $total_coe);
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			<td>Salaries</td>
			<td>5&#32;01&#32;01&#32;010</td>
			<td><input type="number" id="salaries" name="salaries" class="w3-input" step="any" min=0 value="0.00"></td>
		...
		<tr>
			<td>PERA</td>
			<td>5&#32;01&#32;02&#32;010</td>
			<td><input type="number" id="PERA" name="PERA" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			<td>RA</td>
			<td>5&#32;01&#32;02&#32;020</td>
			<td><input type="number" id="RA" name="RA" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			<td>TA</td>
			<td>5 &#32; 01 &#32; 02 &#32; 030</td>
			<td><input type="number" id="TA" name="TA" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 040</td>
			<td><input type="number" id="clothing_allowance" name="clothing_allowance" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			<td>Honoraria</td>
			<td>5 &#32; 01 &#32; 02 &#32; 100</td>
			<td><input type="number" id="honoraria" name="honoraria" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 140</td>
			<td><input type="number" id="year_end" name="year_end" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			<td>Cash Gift</td>
			<td>5 &#32; 01 &#32; 02 &#32; 150</td>
			<td><input type="number" id="cash_gift" name="cash_gift" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 990-1</td>
			<td><input type="number" id="mid_year" name="mid_year" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			<td>PIB</td>
			<td>5 &#32; 01 &#32; 02 &#32; 080</td>
			<td><input type="number" id="pib" name="pib" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 010</td>
			<td><input type="number" id="gsis" name="gsis" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 020</td>
			<td><input type="number" id="hdmf" name="hdmf" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 030</td>
			<td><input type="number" id="philHealth" name="philHealth" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 040</td>
			<td><input type="number" id="ecc" name="ecc" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="terminal-leave" name="terminal-leave" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="personel" name="personel" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 01 &#32; 010</td>
			<td><input type="number" id="tev" name="tev" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 02 &#32; 010</td>
			<td><input type="number" id="training" name="training" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 05 &#32; 030</td>
			<td><input type="number" id="telephone" name="telephone" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 05 &#32; 010</td>
			<td><input type="number" id="postage" name="postage" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 16 &#32; 030</td>
			<td><input type="number" id="insurance-premium" name="insurance-premium" class="w3-input" step=0.01 min=0  value="0.00"></td>
			
		</tr>
		
		<tr>
			<td>Fedility Bond Premium</td>
			<td>5&#32; 02 &#32; 16 &#32; 020</td>
			<td><input type="number" id="fedility-premium" name="fedility-premium" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 03 &#32; 010</td>
			<td><input type="number" id="office-supplies" name="office-supplies" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 090</td>
			<td><input type="number" id="gasoline" name="gasoline" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 060</td>
			<td><input type="number" id="vehicle-maintenance" name="vehicle-maintenance" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 070</td>
			<td><input type="number" id="equipment" name="equipment" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 10 &#32; 020</td>
			<td><input type="number" id="confidential" name="confidential" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 99 &#32; 990</td>
			<td><input type="number" id="other-maintenance" name="other-maintenance" class="w3-input" step=0.01 min=0  value="0.00"></td>
		...
		<tr>
			...
			<td>1&#32;07&#32;05&#32;020</td>
			<td><input type="number" id="capital-outlay" name="capital-outlay" class="w3-input" step=0.01 min=0  value="0.00"></td>

...
$isLoaded = check_if_loaded_mswd_aip();
		...
		if ($isLoaded == '1'){
			...
			header("location: aipMSWDreadonly.php");
			}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, salaries, PERA, RA, TA, clothing_allowance, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, subsistenceAllowance, other_personal, total_ps,
...
<thead>
	...
	<th>Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 040</td>
			<td><input type="number" id="ecc" name="ecc" class="w3-input" step="any" value="0.00" step="any" value="0.00"></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="subsistence-allowance" name="subsistence-allowance" class="w3-input" step="any" value="0.00"></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 99 &#32; 080</td>
			<td><input type="number" id="aics" name="aics" class="w3-input" step="any" value="0.00"></td>

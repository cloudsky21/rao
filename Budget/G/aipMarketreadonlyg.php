...
mysqli_set_charset($db,"utf8");
	...
	total_mooe = ?, 
	co = ?, 
	total_co = ? WHERE departments = 'MBE' && Year = ?  ";
	
	if ($result = mysqli_prepare($db, $query)){
		
	mysqli_stmt_bind_param($result,"ssssssssssssssssssssss",
	$post_salary, 
	$post_pera, 
	$post_aca, 
	$post_clothing, 
...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			<td>5&#32;01&#32;02&#32;020</td>
			<?PHP
			$aca = floatval(select_aip_aca());
			echo '<td>'.number_format($aca,2).'</td>';
			echo '<td><input type="number" id="ACA" name="ACA" class="w3-input" value="'.$aca.'" tabindex="3" step="any"></td>';
			echo '<td><input type="text" class="w2-input" readonly value="'.number_format(select_aip_aca_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 040</td>
			<?PHP
			$slaught = floatval(select_aip_slaught());
			echo '<td>'.number_format($slaught,2).'</td>';
			echo '<td><input type="number" id="market-slaughter" name="market-slaughter" class="w3-input" value="'.$slaught.'" tabindex="20" step="any"></td>';
			echo '<td><input type="text" class="w2-input" readonly value="'.number_format(select_aip_slaught_bal(),2).'"></td>';
			?>
		</tr>						
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="w3-input" value="'.$coo.'" tabindex="20" step="any"></td>';

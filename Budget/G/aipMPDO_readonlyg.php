...
mysqli_set_charset($db,"utf8");
	...
	$post_oba = mysqli_real_escape_string($db, $_POST['oba']);
...
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="aipMPDO.php"  class="active">MPDO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mpdo_all.php">Personnel Services</a>
  <a href="mooe_mpdo_all.php">Maint. &amp; Other Operating Expenses</a>
  <a href="co_mpdo_all.php">Capital Outlay</a>
</div>
<div id="main">
...
echo '</thead>';
	...
	$per = floatval(select_aip_pera());
		...
		echo '<tr>';
			...
			echo '<td><input type="number" id="PERA" name="PERA" class="w3-input" value="'.$per.'"tabindex = "2"></td>';
	...
	$rat = floatval(select_aip_ra());
		...
		echo '<tr>';
			...
			echo '<td><input type="number" id="RA" name="RA" class="w3-input" value="'.$rat.'" tabindex = "3"></td>';
	...
	$ta = floatval(select_aip_ta());
		...
		echo '<tr>';
			...
			echo '<td><input type="number" id="TA" name="TA" class="w3-input" value="'.$ta.'" tabindex = "4"></td>';
	...
	$cloth = floatval(select_aip_cloth());
		...
		echo '<tr>';
			...
			echo '<td><input type="number" id="clothing_allowance" name="clothing_allowance" class="w3-input" value="'.$cloth.'" tabindex = "5"></td>';
	...
	$yend = floatval(select_aip_yend());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="year_end" name="year_end" class="w3-input" value="'.$yend.'" tabindex = "6"></td>';
	...
	$gft = floatval(select_aip_gft());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="cash_gift" name="cash_gift" class="w3-input" value="'.$gft.'" tabindex = "7"></td>';
	...
	$mid = floatval(select_aip_mid());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="mid_year" name="mid_year" class="w3-input" value="'.$mid.'" tabindex = "8"></td>';
	...
	$pi = floatval(select_aip_pib());
		echo '<tr>';
			...
			echo '<td><input type="number" id="pib" name="pib" class="w3-input" value="'.$pi.'" tabindex = "9"></td>';
	...
	$gs = floatval(select_aip_gsis());
		echo '<tr>';
			...
			echo '<td><input type="number" id="gsis" name="gsis" class="w3-input" value="'.$gs.'" tabindex = "10"></td>';
	...
	$love = floatval(select_aip_hdmf());
		echo '<tr>';
			...
			echo '<td><input type="number" id="hdmf" name="hdmf" class="w3-input" value="'.$love.'" tabindex = "11"></td>';
	...
	$cares = floatval(select_aip_philhealth());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="philHealth" name="philHealth" class="w3-input" value="'.$cares.'" tabindex = "12"></td>';
	...
	$ec = floatval(select_aip_ecc());
		echo '<tr>';
			...
			echo '<td><input type="number" id="ecc" name="ecc" class="w3-input" value="'.$ec.'" tabindex = "13"></td>';
	...
	$obas = floatval(select_aip_oba());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="oba" name="oba" class="w3-input" value="'.$obas.'" tabindex = "14"></td>';
			echo '<td><input type="text" class="w2-input" readonly value="'.number_format(select_aip_oba_bal(),2).'"></td>';
		echo '</tr>';
	...
	$totps = floatval(select_aip_totps());
		echo '<tr>';
			...
			echo '<td><input type="text" id="total-personal-services" name="total-personal-services" class="w2-input" value="'.$totps.'"></td>';
	...
	$travel = floatval(select_aip_travel());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="tev" name="tev" class="w3-input" value="'.$travel.'" tabindex = "15"></td>';
	...
	$training = floatval(select_aip_training());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="training" name="training" class="w3-input" value="'.$training.'" tabindex = "16"></td>';
	...
	$phonegraph = floatval(select_aip_telegraph());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="telephone" name="telephone" class="w3-input" value="'.$phonegraph.'" tabindex = "17"></td>';
	...
	$offs = floatval(select_aip_office());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="office-supplies" name="office-supplies" class="w3-input" value="'.$offs.'" tabindex = "18"></td>';
	...
	$ot = floatval(select_aip_others());	
		echo '<tr>';
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" class="w3-input" value="'.$ot.'" tabindex = "19"></td>';
	...
	$totmoe = floatval(select_aip_totalmoe());
		echo '<tr>';
			...
			echo '<td>'.number_format(select_aip_totalmoe(),2).'</td>';
			echo '<td><input type="text" id="total-maint-services" name="total-maint-services" class="w2-input" readonly value="'.$totmoe.'"></td>';
	...
	$co = floatval(select_aip_co());
		echo '<tr>';
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="w3-input" value="'.$co.'" tabindex = "20"></td>';

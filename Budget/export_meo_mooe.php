...
$sqlExcel = "SELECT * FROM meomooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->setTitle('MOOEMEO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Engineers Office');
...
foreach ($result as $row)
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount,$row['others']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_others());
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_others_bal());

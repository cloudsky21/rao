...
include("cfg.php");
include("functions_mooe_meo.php");
...
$result->execute([$total, "MEO", $_SESSION['budget']]);
/* ------------------------------*/
get_total_tev();
get_total_trainings();
get_total_postage();
...
//numbers	
	...
	$totalObligation = $post_tev + $post_trainings  + $post_post + $post_supplies +  $post_other;

	$query = "INSERT INTO meomooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM meomooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE meomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM meomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Engineering Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_meo_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_meo_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_meo_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_meo_mooe">Export to Excel</a></li>
							<li><a href="personal_services_meo_all">Personal Services</a></li>
							<li><a href="co_meo_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmeo1">January</a></li>
							<li><a href="mmeo2">February</a></li>
							<li><a href="mmeo3">March</a></li>
							<li><a href="mmeo4">April</a></li>
							<li><a href="mmeo5">May</a></li>
							<li><a href="mmeo6">June</a></li>
							<li><a href="mmeo7">July</a></li>
							<li><a href="mmeo8">August</a></li>
							<li><a href="mmeo9">September</a></li>
							<li><a href="mmeo10">October</a></li>
							<li><a href="mmeo11">November</a></li>
							<li><a href="mmeo12">December</a></li>
				...
				<div class="modal-body">
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								<td>Postage and<br> Deliveries</td>
							...
							<tr>
								...
								<td><input class="form-control" type="number" step="any" name="other" min=0></td>
							</tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Engineering Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM meomooe WHERE yearm = ?");

...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_salaries FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_PERA FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_RA FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
$col1 = $row['balance_RA'];
return $col1;
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_TA FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
$col1 = $row['balance_TA'];
return $col1;
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_clothing_allowance FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_year_end FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_cash_gift FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_mid_year FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_pib FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_life_retirement FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_pag_ibig FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_philhealth FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_ecc FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT total_ps FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
$col1 = $row['total_ps'];
return $col1;
...
$year = $_SESSION['budget'];
$query2 = "UPDATE aip SET total_ps_balance = '$total_bal_ps' WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
...
$year = $_SESSION['budget'];
$query2 = "SELECT total_ps_balance FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_tev FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_training_seminars FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT telephone_telegraph FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_telephone_telegraph FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_postage FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT fidelity_bond FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_fidelity_bond FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_office_supplies FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT advertising_expenses FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_advertising_expenses FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_others FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT total_mooe FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
$col1 = $row['total_mooe'];
return $col1;
...
$totmooe =  $travel + $training + $pst + $offs + $ot;

$year = $_SESSION['budget'];
$query2 = "UPDATE aip SET balance_mooe = '$totmooe' WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_mooe FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT co FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
$col1 = $row['co'];
return $col1;
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_co FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT terminal_leave FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_terminal_leave FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);
...
$year = $_SESSION['budget'];
$query2 = "SELECT balance_other_personal FROM aip WHERE departments = 'LCR' && Year = '$year'";
$result2 = mysqli_query($db,$query2);
$row = mysqli_fetch_array($result2,MYSQLI_ASSOC);

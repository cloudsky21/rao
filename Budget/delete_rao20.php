...
$query = "DELETE FROM r20edf WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">20&#37; EDF
</label>
<div id="container">
	<div class="wrap">
		<ul>
			
			<li><a href="delete_rao20.php" class="active">20&#37; EDF</a></li>
...
$result = $db->prepare("SELECT * FROM r20edf WHERE yearm =?");

...
$sqlExcel = "SELECT * FROM mbomooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->setTitle('MOOEMBO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Budget Office');
...
$objPHPExcel->getActiveSheet()->SetCellValue('J13','Other Maintenance and Operating Expenses');
$objPHPExcel->getActiveSheet()->SetCellValue('J14','05   02   99   990');
...
foreach ($result as $row)
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount,$row['others_maint']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_others_maint());
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_others_maint_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow2, get_aip_others());

...
include("cfg.php");
include("functions_mooe_masso.php");
...
//numbers	
	...
	$post_eq = $_POST['offequip'];	
	$post_others = $_POST['others'];
	
	$totalObligation = $post_tev + $post_trainings + $post_post + $post_supplies + $post_eq + $post_others;

	$query = "INSERT INTO massomooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM massomooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE massomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM massomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Assessors Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_masso_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_masso_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_masso_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_masso_mooe">Export to Excel</a></li>
							<li><a href="personal_services_masso_all">Personal Services</a></li>
							<li><a href="co_masso_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmasso1">January</a></li>
							<li><a href="mmasso2">February</a></li>
							<li><a href="mmasso3">March</a></li>
							<li><a href="mmasso4">April</a></li>
							<li><a href="mmasso5">May</a></li>
							<li><a href="mmasso6">June</a></li>
							<li><a href="mmasso7">July</a></li>
							<li><a href="mmasso8">August</a></li>
							<li><a href="mmasso9">September</a></li>
							<li><a href="mmasso10">October</a></li>
							<li><a href="mmasso11">November</a></li>
							<li><a href="mmasso12">December</a></li>
				...
				<div class="modal-body">
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								<td>Training &amp; Seminar<br> Expenses</td>
							...
							<tr>
								...
								<td><input class="form-control" type="number" step="any" name="offequip" min=0></td>
							</tr>
							<tr>
								<td>Other Maintenance <br>and Operating Expenses</td>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Assessors Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM massomooe WHERE yearm = ?");

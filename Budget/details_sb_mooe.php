...
$result = $db->prepare("SELECT * FROM sbmooe WHERE alobs = ? AND yearm = ?");
...
?>
			...
			<ul class="list-group">
				...
				if($ads !="0.00"){ echo'<li class="list-group-item">Advertising Expenses<span class="badge">'.number_format($ads,2).'</span></li>';} else{} 

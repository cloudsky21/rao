...
$sqlExcel = "SELECT * FROM massomooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->setTitle('MOOEMASSO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Assessors Office');
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_offequip());
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_offequip_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow2, get_aip_offequip());

...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmpdo WHERE alobs = ?");
	$result->execute([$rec]);
...
if(isset($_POST['submit_edit_ps_mpdo'])){
...
$result = $db->prepare("SELECT sum(total) as total FROM psmpdo WHERE year_transact = ?");
...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmpdo WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Mun. Planning and Development Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mpdo_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mpdo_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mpdo_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					<li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Menu
						...
						<ul class="dropdown-menu">
							...
							<li><a href="export_mpdo_ps">Export to Excel</a></li>
					...
					<li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Settings <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mooe_mpdo_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_mpdo_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmpdo1">January</a></li>
							<li><a href="pmpdo2">February</a></li>
							<li><a href="pmpdo3">March</a></li>
							<li><a href="pmpdo4">April</a></li>
							<li><a href="pmpdo5">May</a></li>
							<li><a href="pmpdo6">June</a></li>
							<li><a href="pmpdo7">July</a></li>
							<li><a href="pmpdo8">August</a></li>
							<li><a href="pmpdo9">September</a></li>
							<li><a href="pmpdo10">October</a></li>
							<li><a href="pmpdo11">November</a></li>
							<li><a href="pmpdo12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Mun. Planning and Development Office <small>Personal Services</small></h2>
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<form action="" method="POST">
							...
							<div class="modal-footer">
								<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
								<button type="submit" name="submit_edit_ps_mpdo" class="btn btn-success">Update</button>
							</div>
						</form>
					</div>
				</div>
			...
			<div class="modal fade" id="addObl" role="dialog">
							...
							<div class="modal-body">
								<table class="table borderless">
									<tr>
										...
										<td style="border-bottom: none;">ALOBS</td>
										<td style="border-bottom: none;">Claimant</td>
									</tr>

									<div class = "form-group">
										<tr>
											<td><strong><input type="date" name="date" value="<?PHP echo $_SESSION['budget']."-".date("m-d"); ?>" min="<?PHP echo $_SESSION['budget']."-01-01"; ?>" max="<?PHP echo $_SESSION['budget']."-".date("m-d"); ?>" class="form-control"></strong></td>
											<td><input type="number" name="alobs" id="alobs" required min="0" step="any" max=999 class="form-control"></td>
											<td><input type="text" id="claimant" name="claimant" placeholder="Juan Dela Cruz et. al." required class="form-control"></td>
										</tr>
										...
										<tr>
											...
											<td><input type="number" step="any" name="salaries" class="form-control"></td>
										</tr>
										...
										<tr>
											...
											<td><input type="number" step="any" name="pera"  class="form-control"></td>
										</tr>
										
										<tr>
											<td>RA</td>
											<td class="textc">01 &nbsp; 02 &nbsp;	020</td>
											<td><input type="number" step="any" name="ra"  class="form-control"></td>
										</tr>
										
										<tr>
											<td>TA</td>
											<td class="textc">01 &nbsp; 02 &nbsp;	030</td>
											<td><input type="number" step="any" name="ta"  class="form-control"></td>
										</tr>
										
										<tr>
											<td>Clothing Allowance</td>
											<td class="textc">01 &nbsp; 02 &nbsp;	040</td>
											<td><input type="number" step="any" name="cloth" class="form-control"></td>
										</tr>
										
										<tr>
											<td>Year End Bonus</td>
											<td class="textc">01 &nbsp; 02 &nbsp;	140</td>
											<td><input type="number" step="any" name="year_end" class="form-control"></td>
										</tr>
										
										<tr>
											<td>Cash Gift</td>
											<td class="textc">01 &nbsp; 02 &nbsp;	150</td>
											<td><input type="number" step="any" name="cash_gift"  class="form-control"></td>
										</tr>
										
										<tr>
											<td>Mid-Year Bonus</td>
											<td class="textc">01 &nbsp; 02 &nbsp;	990-1</td>
											<td><input type="number" step="any" name="mid_year" class="form-control" ></td>
										</tr>
										
										<tr>
											<td>PIB</td>
											<td class="textc">01 &nbsp; 02 &nbsp;	080</td>
											<td><input type="number" step="any" name="pib"  class="form-control"></td>
										</tr>
										
										<tr>
											<td>Life &amp; Retirement Insurance</td>
											<td class="textc">01 &nbsp; 03 &nbsp;	010</td>
											<td><input type="number" step="any" name="gsis"  class="form-control"></td>
										</tr>
										
										<tr>
											<td>Pag-Ibig Contributions</td>
											<td class="textc">01 &nbsp; 03 &nbsp;	020</td>
											<td><input type="number" step="any" name="hdmf"  class="form-control"></td>
										</tr>
										
										<tr>
											<td>PHILHEALTH Contributions</td>
											<td class="textc">01 &nbsp; 03 &nbsp;	030</td>
											<td><input type="number" step="any" name="care" class="form-control"></td>
										</tr>
										
										<tr>
											<td>ECC Contributions</td>
											<td class="textc"01 &nbsp; 03 &nbsp;	040</td>
												<td><input type="number" step="any" name="ecc" class="form-control"></td>
											</tr>
											
											<tr>
												<td>Other Bonuses and Allowances</td>
												<td class="textc">&nbsp;</td>
												<td><input type="number" step="any" name="others" class="form-control"></td>
											</tr>
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tbody>	
						<?PHP
						$result= $db->prepare("SELECT * FROM psmpdo WHERE year_transact = ? ORDER BY alobs DESC");
						$result->execute([$_SESSION['budget']]);

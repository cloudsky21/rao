...
$query = "DELETE FROM mpdomooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Planning and Development Office</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Planning and Development Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			<li><a href="delete_mooe_mmo.php">MMO</a></li>
			<li><a href="delete_mooe_sb.php">SB</a></li>
			<li><a href="delete_mooe_mpdo.php"  class="active">MPDO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mpdo_all.php">Personal Services</a>
  <a href="mooe_mpdo_all.php">Maint. and Other Operating Expenses</a>
...
$result = $db->prepare("SELECT * FROM mpdomooe WHERE yearm =?");

...
include("cfg.php");
include("functions_mooe_mbo.php");
...
$result = $db->prepare("SELECT sum(total) as total FROM mbomooe WHERE yearm = ?");
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM mbomooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE mbomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM mbomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Budget Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mbo_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mbo_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mbo_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mbo_mooe">Export to Excel</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmbo1">January</a></li>
							<li><a href="mmbo2">February</a></li>
							<li><a href="mmbo3">March</a></li>
							<li><a href="mmbo4">April</a></li>
							<li><a href="mmbo5">May</a></li>
							<li><a href="mmbo6">June</a></li>
							<li><a href="mmbo7">July</a></li>
							<li><a href="mmbo8">August</a></li>
							<li><a href="mmbo9">September</a></li>
							<li><a href="mmbo10">October</a></li>
							<li><a href="mmbo11">November</a></li>
							<li><a href="mmbo12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td><input type="number" step="any" name="telephone_telegraph" min=0 class="form-control"></td>
							</tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Budget Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM mbomooe WHERE yearm = ?");

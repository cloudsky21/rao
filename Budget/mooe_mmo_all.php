...
get_total_telephone();
get_total_postage();
get_total_insurance_p();
get_total_fidelity_b();
get_total_officeSupplies();
get_total_gasoline();
get_total_motor_maint();
get_total_officeEquip_maint();
get_total_confidential();
...
get_gasoline_bal();
get_motor_maint_bal();
get_officeEquip_maint_bal();
get_confidential_bal();
...
//numbers	
	...
	$post_insurance = $_POST['insurance'];
	$post_fidelity = $_POST['fidelity'];	
	$post_supplies = $_POST['supplies'];	
	$post_gas = $_POST['gas'];	
	$post_mot_vehicle = $_POST['mot_vehicle'];	
	$post_offceEquip = $_POST['officeEquip'];
	$post_cIntExp = $_POST['cIntExp'];
	...
	$query = "INSERT INTO mmomooe (yearm, month, day, alobs, claimant, description, tev, training, telephone, postage, insurance_p, fidelity_b,officeSupplies, gasoline, motor_maint, officeEquip_maint, confidential, others_maint, total) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";

	$result = $db->prepare($query);
	$result->execute([$get_date_Y, $get_date_m, $get_date_d, $post_alobs, $post_claimant, $post_description, $post_tev,$post_trainings,$post_tel,$post_postage,$post_insurance,$post_fidelity,$post_supplies,$post_gas,$post_mot_vehicle,$post_offceEquip,$post_cIntExp,$post_others,$totalObligation]);  
...
//numbers	
	...
	$result = $db->prepare("UPDATE mmomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM mmomooe WHERE alobs = ?");
...
$result = $db->prepare("SELECT SUM(total) AS total FROM mmomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Mayors Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mmo_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mmo_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mmo_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmmo1">January</a></li>
							<li><a href="mmmo2">February</a></li>
							<li><a href="mmmo3">March</a></li>
							<li><a href="mmmo4">April</a></li>
							<li><a href="mmmo5">May</a></li>
							<li><a href="mmmo6">June</a></li>
							<li><a href="mmmo7">July</a></li>
							<li><a href="mmmo8">August</a></li>
							<li><a href="mmmo9">September</a></li>
							<li><a href="mmmo10">October</a></li>
							<li><a href="mmmo11">November</a></li>
							<li><a href="mmmo12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td><input type="number" step="any" name="postage" min=0 class="form-control" ></td>
							</tr>

							<tr>
								<td>Insurance Premium</td>
								<td class="help-block">02 &nbsp; 16 &nbsp;	030</td>
								<td><input type="number" step="any" name="insurance" min=0 class="form-control" ></td>
							</tr>

							<tr>
								<td>Fidelity Bond Premium</td>
								<td class="help-block">02 &nbsp; 16 &nbsp;	020</td>
								<td><input type="number" step="any" name="fidelity" min=0 class="form-control" ></td>
							</tr>
							...
							<tr>
								...
								<td><input type="number" step="any" name="gas" min=0 class="form-control" ></td>
							</tr>

							<tr>
								<td>Motor Vehicle Maintenance</td>
								<td class="help-block">02 &nbsp; 13 &nbsp;	060</td>
								<td><input type="number" step="any" name="mot_vehicle" min=0 class="form-control" ></td>
							</tr>

							<tr>
								<td>Office Equipment Maintenance</td>
								<td class="help-block">02 &nbsp; 13 &nbsp;	070</td>
								<td><input type="number" step="any" name="officeEquip" min=0 class="form-control" ></td>
							</tr>

							<tr>
								<td>Confidential and Intelligence Expenses</td>
								<td class="help-block">02 &nbsp; 10 &nbsp;	020</td>
								<td><input type="number" step="any" name="cIntExp" min=0 class="form-control" ></td>
							</tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mayors Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>

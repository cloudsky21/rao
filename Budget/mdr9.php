...
$table = "mdr".$_SESSION['budget'];
try{
refresh_all();
}
catch(Exception $e)
{
	echo ("Setup AIP for 5% Municipal Disaster Risk. This page will be redirected.. in 3 seconds");
	header('Refresh: 3; url=aipmdrsetup');
	exit();
...
<title>Report | 5% Municipal Disaster Risk</title>
     ...
     <li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Registry Allotment and Obligations (RAO)
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_mdr">Export to Excel</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
	  ...
	  <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="mdr1">January</a></li>
					<li><a href="mdr2">February</a></li>
					<li><a href="mdr3">March</a></li>
					<li><a href="mdr4">April</a></li>
					<li><a href="mdr5">May</a></li>
					<li><a href="mdr6">June</a></li>
					<li><a href="mdr7">July</a></li>
					<li><a href="mdr8">August</a></li>
					<li><a href="mdr9">September</a></li>
					<li><a href="mdr10">October</a></li>
					<li><a href="mdr11">November</a></li>
					<li><a href="mdr12">December</a></li>
...
<h2>5% Municipal Disaster Risk <br><small>September <?php echo $_SESSION['budget'] ?></small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mdr,2); ?></span></li>
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mdr - $nt_9, 2); ?></span></li>

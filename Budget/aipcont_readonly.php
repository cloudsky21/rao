...
<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>Continuing Program </strong></label>  
...
<thead>
	...
	<th>Balance<br>&#40;3&#41;</th>
		...
		<?PHP 
		$tablename = "cont_list_".$_SESSION['budget']; //gad_list_(current Year) table
		...
		foreach($edfCyTbl as $list){
			...
			$table2 = "cont".$_SESSION['budget']; //gad_CY table
			$codelist = $list['code'];
			...
			$tablerao = "rcont".$_SESSION['budget'];

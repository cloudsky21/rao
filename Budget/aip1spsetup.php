...
try{
	...
	$table_aip = "1sp".$_SESSION['budget'];
	$table_20 = "r1sp".$_SESSION['budget'];
...
try
{
	...
	$tablename_1sp = "1sp".$_SESSION['budget'];
	$query = "ALTER TABLE `$tablename_1sp` ADD `$addcolumn` DECIMAL(20,2) NOT NULL AFTER `$last_column`, 
...
<div class="container">
	<div style="margin-top: 100px;">
		...
		<div class="page-header">
			<h2>Setup Senior Citizen & Persons With Disability</h2>
		</div>
  

			
				<label>Table: <STRONG>SC/PWDs Programs from previous year</strong> </label>  
						...
						<table  class="table table-condensed table-hover">
							...
							<tbody>
								...
								try{
									...
									$result = $db->prepare("SELECT * FROM 1sp_list_".$sget."");
									$result->execute();

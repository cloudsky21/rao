...
$sqlExcel = "SELECT * FROM gsmooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->setTitle('MOOEGS');
...
$objPHPExcel->getActiveSheet()->SetCellValue('G13','Office Supplies');
$objPHPExcel->getActiveSheet()->SetCellValue('G14','05   02   03   010');

$objPHPExcel->getActiveSheet()->SetCellValue('H13','Water');
$objPHPExcel->getActiveSheet()->SetCellValue('H14','05   02   04  010');

$objPHPExcel->getActiveSheet()->SetCellValue('I13','Electricity');
$objPHPExcel->getActiveSheet()->SetCellValue('I14','05   02  04  020');

$objPHPExcel->getActiveSheet()->SetCellValue('J13','Gasoline, Oil & Lubricants');
$objPHPExcel->getActiveSheet()->SetCellValue('J14','05   02   03   090');

$objPHPExcel->getActiveSheet()->SetCellValue('K13','Motor Vehicle Maintenance');
$objPHPExcel->getActiveSheet()->SetCellValue('K14','05   02   13   060');
...
foreach ($result as $row)
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('G'.$rowCount,$row['officeSupplies']);
	$objPHPExcel->getActiveSheet()->SetCellValue('H'.$rowCount,$row['water']);
	$objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount,$row['electricity']);
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount,$row['gasoline']);
	$objPHPExcel->getActiveSheet()->SetCellValue('K'.$rowCount,$row['motor_vehicle_maint']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('G'.$getRow, get_total_officeSupplies());
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$getRow, get_total_water());
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow, get_total_electricity());	
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_gasoline());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow, get_total_mm());	
...
$objPHPExcel->getActiveSheet()->SetCellValue('G'.$getRow1, get_officeSupplies_bal());		
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$getRow1, get_water_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow1, get_electricity_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_gasoline_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow1, get_mm_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('G'.$getRow2, get_aip_officeSupplies());		
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$getRow2, get_aip_water());
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow2, get_aip_electricity());
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow2, get_aip_gasoline());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow2, get_aip_mm());

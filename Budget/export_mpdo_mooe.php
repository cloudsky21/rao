...
$sqlExcel = "SELECT * FROM mpdomooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->setTitle('MOOEMPDO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Mun. Planning & Development Office');

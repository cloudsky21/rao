...
$result = $db->prepare("INSERT INTO mpdoco (yearm, month, day, alobs, claimant, description, capital_outlay, total) VALUES (?, ?, ?, ?, ?, ?, ?,?)");
...
$result = $db->prepare("DELETE FROM mpdoco WHERE alobs = ?");
...
$result = $db->prepare("UPDATE mpdoco SET 
yearm=?, 
month=?, 
day=?, 
alobs=?, 
...
<title>CO | Mun. Planning and Development Office</title>
...
$(document).ready(function(){
    $('#infoModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'details_mpdo_co.php', //Here you will fetch records 
...
$(document).ready(function(){
    $('#editModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'edit_mpdo_co.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
...
$(document).ready(function(){
    $('#deleteModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'delete_mpdo_co.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
            }
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_mpdo_co">Export to Excel</a></li>
			<li><a href="personal_services_mpdo_all">Personal Services</a></li>
			<li><a href="mooe_mpdo_all">Maintenance and Other Operating Expenses</a></li>
															...
															<div class="container">
																<div style="margin-top: 100px;">
																	<div class="page-header">
																		<h2>Mun. Planning and Development Office <small>Capital Outlay</small></h2>
																	</div>
...
$result = $db->prepare("SELECT * FROM mpdoco WHERE yearm = ? ORDER BY alobs DESC");

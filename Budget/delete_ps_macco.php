...
$query = "DELETE FROM psmacco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Accounting Office</title>
...
<body>
<label id="accountTitle">Personel Services - MACCO - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_macco.php"  class="active">MACCO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_macco_all.php">Personal Services</a>
  <a href="mooe_macco_all.php">Maint. and Other Operating Expenses</a>
...
$result = $db->prepare("SELECT * FROM psmacco WHERE year_transact =?");

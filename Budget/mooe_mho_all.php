...
include("cfg.php");
include("functions_mooe_mho.php");
...
//numbers	
	...
	$totalObligation = $post_tev + $post_trainings  + $post_supplies + $post_mm + $post_tel + $post_others;

	$query = "INSERT INTO mhomooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM mhomooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE mhomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM mhomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Health Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mho_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mho_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mho_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mho_mooe">Export to Excel</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmho1">January</a></li>
							<li><a href="mmho2">February</a></li>
							<li><a href="mmho3">March</a></li>
							<li><a href="mmho4">April</a></li>
							<li><a href="mmho5">May</a></li>
							<li><a href="mmho6">June</a></li>
							<li><a href="mmho7">July</a></li>
							<li><a href="mmho8">August</a></li>
							<li><a href="mmho9">September</a></li>
							<li><a href="mmho10">October</a></li>
							<li><a href="mmho11">November</a></li>
							<li><a href="mmho12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td><input type="number" step="any" name="mm" min=0 class="form-control"></td>
							</tr>
							<tr>
								<td>Telephone / Telegraph<br> and Internet</td>
								<td class="help-block">02 &nbsp; 05 &nbsp; 030</td>
								<td><input type="number" step="any" name="telephone" min=0 class="form-control"></td>
							</tr>
							<tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Health Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM mhomooe WHERE yearm = ?");

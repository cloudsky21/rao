...
include("cfg.php");
include("functions_ps_masso.php");
...
$result = $db->prepare("SELECT sum(total) as total FROM psmasso WHERE year_transact = ?");
...
$result->execute([$total, "MASSO", $_SESSION['budget']]);
/* ------------------------------*/
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmasso WHERE alobs = ?");
	$result->execute([$rec]);
...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmasso WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Municipal Assessors Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_masso_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_masso_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_masso_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mbo_ps">Export to Excel</a></li>
							<li><a href="mooe_mbo_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_mbo_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmasso1">January</a></li>
							<li><a href="pmasso2">February</a></li>
							<li><a href="pmasso3">March</a></li>
							<li><a href="pmasso4">April</a></li>
							<li><a href="pmasso5">May</a></li>
							<li><a href="pmasso6">June</a></li>
							<li><a href="pmasso7">July</a></li>
							<li><a href="pmasso8">August</a></li>
							<li><a href="pmasso9">September</a></li>
							<li><a href="pmasso10">October</a></li>
							<li><a href="pmasso11">November</a></li>
							<li><a href="pmasso12">December</a></li>
		...
		<div class="container">
			...
			<div style="margin-top: 100px;">
				...
				<div class="page-header">
					...
					<h2>Mun. Assessors Office <small>Personal Services</small></h2>
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tbody>
						...
						$result = $db->prepare("SELECT * FROM psmasso WHERE year_transact = ? ORDER BY alobs DESC");

...
?>
			...
			<ul class="list-group">
				...
				if($honoraria !="0.00"){ echo'<li class="list-group-item">Honoraria<span class="badge">'.number_format($honoraria,2).'</span></li>';} else{} 
				...
				if($terminal_benefits !="0.00"){ echo'<li class="list-group-item">Terminal Leave Benefits<span class="badge">'.number_format($terminal_benefits,2).'</span></li>';} else{} 				
				?>
			</ul>
			</div>	

...
$query = "DELETE FROM meoco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Engineering Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_meo.php"  class="active">MEO</a></li>
...
$result = $db->prepare("SELECT * FROM meoco WHERE yearm =?");

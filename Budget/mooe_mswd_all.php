...
include("cfg.php");
include("functions_mooe_mswd.php");
...
$result->execute([$total, "MSWD", $_SESSION['budget']]);
/* ------------------------------*/
...
//numbers	
	...
	$totalObligation = $post_tev + $post_trainings  + $post_postage + $post_supplies + $post_aics + $post_others;

	$query = "INSERT INTO mswdmooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM mswdmooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE mswdmooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM mswdmooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Social and Development Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mswd_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mswd_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mswd_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mswd_mooe">Export to Excel</a></li>
							<li><a href="personal_services_mswd_all">Personal Services</a></li>
							<li><a href="co_mswd_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmswd1">January</a></li>
							<li><a href="mmswd2">February</a></li>
							<li><a href="mmswd3">March</a></li>
							<li><a href="mmswd4">April</a></li>
							<li><a href="mmswd5">May</a></li>
							<li><a href="mmswd6">June</a></li>
							<li><a href="mmswd7">July</a></li>
							<li><a href="mmswd8">August</a></li>
							<li><a href="mmswd9">September</a></li>
							<li><a href="mmswd10">October</a></li>
							<li><a href="mmswd11">November</a></li>
							<li><a href="mmswd12">December</a></li>
				...
				<div class="modal-body">
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								<td>Grants &amp; Donations (AICS)</td>
								<td class="help-block">02 &nbsp; 99 &nbsp; 080</td>
								<td><input type="number" step="any" name="aics"  min=0 class="form-control"></td>
							</tr>
							<tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Social Welfare Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM mswdmooe WHERE yearm = ?");

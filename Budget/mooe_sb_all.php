...
$result = $db->prepare("SELECT sum(total) as total FROM sbmooe WHERE yearm = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE sbmooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
//numbers	
	...
	$totalObligation = $post_tev + $post_trainings + $post_tel + $post_postage + $post_fidelity + $post_supplies + $post_ads + $post_others;

	$query = "INSERT INTO sbmooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM sbmooe WHERE alobs = ?");
...
$result = $db->prepare("SELECT SUM(total) AS total FROM sbmooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Sangguniang Bayan</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_sb_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_sb_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_sb_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_sb_mooe">Export to Excel</a></li>
							<li><a href="personal_services_sb_all">Personal Services</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="msb1">January</a></li>
							<li><a href="msb2">February</a></li>
							<li><a href="msb3">March</a></li>
							<li><a href="msb4">April</a></li>
							<li><a href="msb5">May</a></li>
							<li><a href="msb6">June</a></li>
							<li><a href="msb7">July</a></li>
							<li><a href="msb8">August</a></li>
							<li><a href="msb9">September</a></li>
							<li><a href="msb10">October</a></li>
							<li><a href="msb11">November</a></li>
							<li><a href="msb12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td class="help-block">02 &nbsp; 99 &nbsp;	010</td>
								<td><input type="number" step="any" name="ads" min=0 class="form-control"></td>
							</tr>
							<tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Sangguniang Bayan <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM sbmooe WHERE yearm = ? ORDER BY alobs DESC");

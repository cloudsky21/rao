...
$query = "DELETE FROM psmasso WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Assessors Office</title>
...
<body>
<label id="accountTitle">Personel Services - MASSO - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_masso.php"  class="active">MASSO</a></li>
...
$result = $db->prepare("SELECT * FROM psmasso WHERE year_transact =?");

...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="ACA" name="ACA" class="form-control" value="'.$aca.'" tabindex="3" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_aca_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="market-slaughter" name="market-slaughter" class="form-control" value="'.$slaught.'" tabindex="20" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_slaught_bal(),2).'"></td>';
			?>
		</tr>						

...
$result = $db->prepare("SELECT SUM(total) AS total FROM lcrco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Local Civil Registrars Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="clcr1">January</a></li>
					<li><a href="clcr2">February</a></li>
					<li><a href="clcr3">March</a></li>
					<li><a href="clcr4">April</a></li>
					<li><a href="clcr5">May</a></li>
					<li><a href="clcr6">June</a></li>
					<li><a href="clcr7">July</a></li>
					<li><a href="clcr8">August</a></li>
					<li><a href="clcr9">September</a></li>
					<li><a href="clcr10">October</a></li>
					<li><a href="clcr11">November</a></li>
					<li><a href="clcr12">December</a></li>
...
<h2>Local Civil Registrar's Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_lcr - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM lcrco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM lcrco WHERE yearm = ? ");

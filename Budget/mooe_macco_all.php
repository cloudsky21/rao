...
//numbers	
	...
	$post_audit = $_POST['audit'];	
	$post_others = $_POST['others'];
	
	$totalObligation = $post_tev + $post_trainings + $post_post + $post_supplies + $post_audit + $post_others;

	$query = "INSERT INTO maccomooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM maccomooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE maccomooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM maccomooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Accounting Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_macco_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_macco_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_macco_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_macco_mooe">Export to Excel</a></li>
							<li><a href="personal_services_macco_all">Personal Services</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mmacco1">January</a></li>
							<li><a href="mmacco2">February</a></li>
							<li><a href="mmacco3">March</a></li>
							<li><a href="mmacco4">April</a></li>
							<li><a href="mmacco5">May</a></li>
							<li><a href="mmacco6">June</a></li>
							<li><a href="mmacco7">July</a></li>
							<li><a href="mmacco8">August</a></li>
							<li><a href="mmacco9">September</a></li>
							<li><a href="mmacco10">October</a></li>
							<li><a href="mmacco11">November</a></li>
							<li><a href="mmacco12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td class="help-block">02 &nbsp; 11 &nbsp; 020</td>
								<td><input class="form-control" type="number" step="any" name="audit" min=0></td>
							</tr>
							<tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Accounting Office <small>Maintenance and Other Operating Expenses</small></h2>
			</div>

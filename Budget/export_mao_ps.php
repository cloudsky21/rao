...
$sqlExcel = "SELECT * FROM psmao WHERE year_transact = '$yy'";
...
$objPHPExcel->getActiveSheet()->setTitle('PSMAO');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Agriculturist Office');

...
$tablename = "rgad".$_SESSION['budget'];
...
$table2 = "gad".$_SESSION['budget']; //20edf_CY table

$tablename = "gad_list_".$_SESSION['budget']; //20_list_(current Year) table

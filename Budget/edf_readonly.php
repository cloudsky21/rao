...
if($_SERVER["REQUEST_METHOD"]=="POST"){
		...
		if(!empty($_POST['amount_adjusted'])){	
			...
			$amountUpdate = $_POST['amount_adjusted'];
				...
				//Loop to update 20edf table
					foreach($_POST['idnumber'] as $key=>$value){
						
					$tb = "20edf".$_SESSION['budget'];	
...
<label>OFFICE &#47; SPECIAL PURPOSE APPROPRIATION: <STRONG>20&#37; EDF</strong></label>  
...
<thead>
	...
	<th>Balance<br>&#40;3&#41;</th>
		...
		foreach($edfCyTbl as $list){
			...
			$tablerao = "r20edf".$_SESSION['budget'];

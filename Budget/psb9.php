...
<title>PS Report | Sangguniang Bayan</title>
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_sb_ps.php">Export to Excel</a></li>
			<li><a href="personal_services_sb_all.php">Personal Services</a></li>
			<li><a href="mooe_sb_all.php">Maint. and Other Operating Expenses</a></li>
			<li><a href="co_sb_all.php">Capital Outlay</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="psb1.php">January</a></li>
					<li><a href="psb2.php">February</a></li>
					<li><a href="psb3.php">March</a></li>
					<li><a href="psb4.php">April</a></li>
					<li><a href="psb5.php">May</a></li>
					<li><a href="psb6.php">June</a></li>
					<li><a href="psb7.php">July</a></li>
					<li><a href="psb8.php">August</a></li>
					<li><a href="psb9.php">September</a></li>
					<li><a href="psb10.php">October</a></li>
					<li><a href="psb11.php">November</a></li>
					<li><a href="psb12.php">December</a></li>
...
<h2>Sangguniang Bayan <br><small>Personal Services (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_sb,2); ?></span></li>
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_sb - $ps_september_total,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM pssb WHERE year_transact = ? AND month_transact = ? ORDER BY alobs DESC");

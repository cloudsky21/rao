...
<body>
	...
	<div class="container">
		...
		<table class="table table-bordered table-condensed table-striped" style="margin-top: 20px;">
			...
			<!---------------------- Personal Services -------------------->		
			<?php 
			$list_e = "sef_list_".$_SESSION['budget'];
			$table_e = "sef".$_SESSION['budget'];
			$rtable_e = "rsef".$_SESSION['budget'];
			$r_appr_e = "0";
			$fObl_e = "0";
			...
			<!---------------------- Personal Services -------------------->		
			<?php 
			$list_s = "sef_list_".$_SESSION['budget'];
			$table_s = "sef".$_SESSION['budget'];
			$rtable_s = "rsef".$_SESSION['budget'];
			$r_appr_s = "0";
			$fObl_s = "0";

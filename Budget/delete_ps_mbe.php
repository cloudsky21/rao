...
$query = "DELETE FROM psmbe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Business Enterprise</title>
...
<body>
<label id="accountTitle">Personel Services - MBE - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_mbe.php"  class="active">MARKET</a></li>

...
$result = $db->prepare("SELECT * FROM psmho WHERE alobs = ? AND year_transact = ?");
...
?>
			...
			<ul class="list-group">
				...
				if($hwb !="0.00"){ echo'<li class="list-group-item">ECC Contributions<span class="badge">'.number_format($hwb,2).'</span></li>';} else{} 

...
<h2>Mun. Social Welfare and Development Office <br><small>Capital Outlay (October <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mswd - $total_10,2); ?></span></li>

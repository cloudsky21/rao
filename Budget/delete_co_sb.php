...
$query = "DELETE FROM sbco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Sangguniang Bayan
</label>
<div id="container">
	<div class="wrap">
		<ul>
			<li><a href="delete_co_mmo.php">MMO</a></li>
			<li><a href="delete_co_sb.php"  class="active">SB</a></li>
...
$result = $db->prepare("SELECT * FROM sbco WHERE yearm =?");

...
$query = "DELETE FROM mpdoco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete CO | Sangguniang Bayan</title>
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Planning and Development Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_mpdo.php"  class="active">MPDO</a></li>
...
$result = $db->prepare("SELECT * FROM mpdoco WHERE yearm =?");

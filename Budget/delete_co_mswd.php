...
$query = "DELETE FROM mswdco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Social Welfare and Development Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			<li><a href="delete_co_mmo.php">MMO</a></li>
			...
			<li><a href="delete_co_mswd.php"  class="active">MSWD</a></li>
...
$result = $db->prepare("SELECT * FROM mswdco WHERE yearm =?");

...
$query = "DELETE FROM mtomooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Treasurers Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_mto.php"  class="active">MTO</a></li>

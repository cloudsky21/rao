...
$isLoaded = check_if_loaded_mmo_aip();
		if ($isLoaded == '1'){
			...
			header("location: aipMMO_readonly");
			}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, sector, refCode, salaries, PERA, RA, TA, clothing_allowance, honoraria, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, other_personal, total_ps,
...
<thead>
	...
	<th style="text-align: center;">Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			<td>Salaries</td>
			<td>5&#32;01&#32;01&#32;010</td>
			<td><input type="number" id="salaries" name="salaries" class="form-control" step="any" min=0  ></td>
		...
		<tr>
			<td>PERA</td>
			<td>5&#32;01&#32;02&#32;010</td>
			<td><input type="number" id="PERA" name="PERA" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			<td>RA</td>
			<td>5&#32;01&#32;02&#32;020</td>
			<td><input type="number" id="RA" name="RA" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			<td>TA</td>
			<td>5 &#32; 01 &#32; 02 &#32; 030</td>
			<td><input type="number" id="TA" name="TA" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 040</td>
			<td><input type="number" id="clothing_allowance" name="clothing_allowance" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			<td>Honoraria</td>
			<td>5 &#32; 01 &#32; 02 &#32; 100</td>
			<td><input type="number" id="honoraria" name="honoraria" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 140</td>
			<td><input type="number" id="year_end" name="year_end" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			<td>Cash Gift</td>
			<td>5 &#32; 01 &#32; 02 &#32; 150</td>
			<td><input type="number" id="cash_gift" name="cash_gift" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 02 &#32; 990-1</td>
			<td><input type="number" id="mid_year" name="mid_year" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			<td>PIB</td>
			<td>5 &#32; 01 &#32; 02 &#32; 080</td>
			<td><input type="number" id="pib" name="pib" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 010</td>
			<td><input type="number" id="gsis" name="gsis" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 020</td>
			<td><input type="number" id="hdmf" name="hdmf" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 030</td>
			<td><input type="number" id="philHealth" name="philHealth" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5 &#32; 01 &#32; 03 &#32; 040</td>
			<td><input type="number" id="ecc" name="ecc" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="terminal-leave" name="terminal-leave" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="personel" name="personel" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 01 &#32; 010</td>
			<td><input type="number" id="tev" name="tev" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 02 &#32; 010</td>
			<td><input type="number" id="training" name="training" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 05 &#32; 030</td>
			<td><input type="number" id="telephone" name="telephone" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 05 &#32; 010</td>
			<td><input type="number" id="postage" name="postage" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 16 &#32; 030</td>
			<td><input type="number" id="insurance-premium" name="insurance-premium" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 16 &#32; 020</td>
			<td><input type="number" id="fedility-premium" name="fedility-premium" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 03 &#32; 010</td>
			<td><input type="number" id="office-supplies" name="office-supplies" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 090</td>
			<td><input type="number" id="gasoline" name="gasoline" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 060</td>
			<td><input type="number" id="vehicle-maintenance" name="vehicle-maintenance" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 070</td>
			<td><input type="number" id="equipment" name="equipment" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 10 &#32; 020</td>
			<td><input type="number" id="confidential" name="confidential" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 99 &#32; 990</td>
			<td><input type="number" id="other-maintenance" name="other-maintenance" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td>1&#32;07&#32;05&#32;020</td>
			<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control" step=0.01 min=0   ></td>
		...
		<tr>
			...
			<td colspan="4"><button class="btn btn-success form-control" type="submit" name ="submit">Submit</button></td>

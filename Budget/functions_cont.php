...
$tablename = "rcont".$_SESSION['budget'];
...
$table2 = "cont".$_SESSION['budget']; //20edf_CY table

$tablename = "cont_list_".$_SESSION['budget']; //20_list_(current Year) table

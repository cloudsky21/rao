...
$result = $db->prepare("INSERT INTO mmoco (yearm, month, day, alobs, claimant, description, capital_outlay, total) VALUES (?, ?, ?, ?, ?, ?, ?,?)");
...
$result = $db->prepare("DELETE FROM mmoco WHERE alobs = ?");
...
$result = $db->prepare("UPDATE mmoco SET 
yearm=?, 
month=?, 
day=?, 
alobs=?, 
...
$(document).ready(function(){
    $('#infoModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'details_mmo_co.php', //Here you will fetch records 
...
$(document).ready(function(){
    $('#editModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'edit_mmo_co.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
...
$(document).ready(function(){
    $('#deleteModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'delete_mmo_co.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
            }
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_mmo_co">Export to Excel</a></li>
			<li><a href="personal_services_mmo_all">Personal Services</a></li>
			<li><a href="mooe_mmo_all">Maintenance and Other Operating Expenses</a></li>
															...
															<div class="container">
																<div style="margin-top: 100px;">
																	<div class="page-header">
																		<h2>Mayors Office <small>Capital Outlay</small></h2>
																	</div>
...
$result = $db->prepare("SELECT * FROM mmoco WHERE yearm = ? ORDER BY alobs DESC");

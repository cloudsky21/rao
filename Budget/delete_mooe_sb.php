...
$query = "DELETE FROM sbmooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Sangguniang Bayan</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Sangguniang Bayan
</label>
<div id="container">
	<div class="wrap">
		<ul>
			<li><a href="delete_mooe_mmo.php">MMO</a></li>
			<li><a href="delete_mooe_sb.php"  class="active">SB</a></li>
...
$result = $db->prepare("SELECT * FROM sbmooe WHERE yearm =?");

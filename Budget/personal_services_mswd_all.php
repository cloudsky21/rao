...
$result = $db->prepare("SELECT sum(total) as total FROM psmswd WHERE year_transact = ?");
...
//numbers	
	...
	$totalObligation = $post_salary +  	$post_pera +$post_ra + $post_ta + $post_cloth+$post_yend+$post_gft+$post_mid+$post_pib+$post_gsis+$post_hdmf+$post_care+$post_ecc + $post_subsistence +$post_others;

	$query = "INSERT INTO psmswd (
	year_transact, 
	month_transact, 
	day_transact, 
	alobs, 
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmswd WHERE alobs = ?");
	$result->execute([$rec]);
...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmswd WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Municipal Social Welfare and Development Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'details_mswd_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'edit_mswd_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'delete_mswd_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings <span class="caret"></span></a>
						<ul class="dropdown-menu">
							<li><a href="export_mswd_ps">Export to Excel</a></li>	
							<li><a href="mooe_mswd_all">Maint. and Other Operating Expenses</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmswd1">January</a></li>
							<li><a href="pmswd2">February</a></li>
							<li><a href="pmswd3">March</a></li>
							<li><a href="pmswd4">April</a></li>
							<li><a href="pmswd5">May</a></li>
							<li><a href="pmswd6">June</a></li>
							<li><a href="pmswd7">July</a></li>
							<li><a href="pmswd8">August</a></li>
							<li><a href="pmswd9">September</a></li>
							<li><a href="pmswd10">October</a></li>
							<li><a href="pmswd11">November</a></li>
							<li><a href="pmswd12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Mun. Social Welfare Development Office <small>Personal Services</small></h2>
									...
									<table id="tb1" class="table table-condensed table-hover borderless">
										...
										<tbody>	
											...
											<tr>
												...
												<td></td>
												<td><input  class="form-control" type="number" step="any" name="subsistence" min=0></td>
											</tr>
											<tr>
			...
			<table class="table table-condensed table-striped table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM psmswd WHERE year_transact = ?");

...
$result = $db->prepare("SELECT SUM(total) AS total FROM maoco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mun. Agriculturist Office</title>
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="personal_services_mao_all">Personal Services</a></li>
			<li><a href="mooe_mao_all">Maintenance and Other Operating Expenses</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmao1">January</a></li>
					<li><a href="cmao2">February</a></li>
					<li><a href="cmao3">March</a></li>
					<li><a href="cmao4">April</a></li>
					<li><a href="cmao5">May</a></li>
					<li><a href="cmao6">June</a></li>
					<li><a href="cmao7">July</a></li>
					<li><a href="cmao8">August</a></li>
					<li><a href="cmao9">September</a></li>
					<li><a href="cmao10">October</a></li>
					<li><a href="cmao11">November</a></li>
					<li><a href="cmao12">December</a></li>
...
<h2>Mun. Agriculturist's Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mao,2); ?></span></li>
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mao - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM maoco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM maoco WHERE yearm = ? ");

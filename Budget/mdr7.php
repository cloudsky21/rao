...
<h2>5% Municipal Disaster Risk <br><small>July <?php echo $_SESSION['budget'] ?></small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mdr - $nt_7, 2); ?></span></li>

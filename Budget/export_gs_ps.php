...
$sqlExcel = "SELECT * FROM psgs WHERE year_transact = '$yy'";
...
$objPHPExcel->getActiveSheet()->setTitle('PSPlaza');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'General Services');
...
$objPHPExcel->getActiveSheet()->SetCellValue('H13','Clothing Allowance');
$objPHPExcel->getActiveSheet()->SetCellValue('H14','05   01   02  	040');

$objPHPExcel->getActiveSheet()->SetCellValue('I13','Year End Bonus');
$objPHPExcel->getActiveSheet()->SetCellValue('I14','05   01   02  	140');

$objPHPExcel->getActiveSheet()->SetCellValue('J13','Cash Gift');
$objPHPExcel->getActiveSheet()->SetCellValue('J14','05   01   02  	150');

$objPHPExcel->getActiveSheet()->SetCellValue('K13','Mid-Year Bonus');
$objPHPExcel->getActiveSheet()->SetCellValue('K14','05   01   02  	990-1');

$objPHPExcel->getActiveSheet()->SetCellValue('L13','PIB');
$objPHPExcel->getActiveSheet()->SetCellValue('L14','05   01   02  	080');

$objPHPExcel->getActiveSheet()->SetCellValue('M13','Life and Retirement Contributions');
$objPHPExcel->getActiveSheet()->SetCellValue('M14','05   01   03  	010');

$objPHPExcel->getActiveSheet()->SetCellValue('N13','Pag-Ibig Contributions');
$objPHPExcel->getActiveSheet()->SetCellValue('N14','05   01   03  	020');

$objPHPExcel->getActiveSheet()->SetCellValue('O13','PhilHealth Contributions');
$objPHPExcel->getActiveSheet()->SetCellValue('O14','05   01   03  	030');

$objPHPExcel->getActiveSheet()->SetCellValue('P13','ECC Contributions');
$objPHPExcel->getActiveSheet()->SetCellValue('P14','05   01   03  	040');

$objPHPExcel->getActiveSheet()->SetCellValue('Q13','Other Personel');
$objPHPExcel->getActiveSheet()->SetCellValue('Q14','Benefits');
...
while ($row = mysqli_fetch_assoc($result))
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('H'.$rowCount,$row['clothing_allowance']);
	$objPHPExcel->getActiveSheet()->SetCellValue('I'.$rowCount,$row['year_end_bonus']);
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount,$row['cash_gift']);
	$objPHPExcel->getActiveSheet()->SetCellValue('K'.$rowCount,$row['mid_year_bonus']);
	$objPHPExcel->getActiveSheet()->SetCellValue('L'.$rowCount,$row['pib']);
	$objPHPExcel->getActiveSheet()->SetCellValue('M'.$rowCount,$row['life_retirement']);
	$objPHPExcel->getActiveSheet()->SetCellValue('N'.$rowCount,$row['pag_ibig']);
	$objPHPExcel->getActiveSheet()->SetCellValue('O'.$rowCount,$row['philhealth']);
	$objPHPExcel->getActiveSheet()->SetCellValue('P'.$rowCount,$row['ecc']);
	$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$rowCount,$row['other_personel_benefits']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$getRow, get_total_cloth());
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow, get_total_yearend());		
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_cashgft());	
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow, get_total_mid_year());
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow, get_total_pib());	
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow, get_total_gsis());		
$objPHPExcel->getActiveSheet()->SetCellValue('N'.$getRow, get_total_hdmf());	
$objPHPExcel->getActiveSheet()->SetCellValue('O'.$getRow, get_total_care());	
$objPHPExcel->getActiveSheet()->SetCellValue('P'.$getRow, get_total_ecc());
$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$getRow, get_total_others());
...
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$getRow1, get_cloth_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow1, get_yearend_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_cashgft_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow1, get_mid_year_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow1, get_pib_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow1, get_gsis_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('N'.$getRow1, get_hdmf_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('O'.$getRow1, get_care_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('P'.$getRow1, get_ecc_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$getRow1, get_others_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('H'.$getRow2, get_aip_cloth());
$objPHPExcel->getActiveSheet()->SetCellValue('I'.$getRow2, get_aip_yend());
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow2, get_aip_cash());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow2, get_aip_mid());
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow2, get_aip_pib());
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow2, get_aip_gsis());
$objPHPExcel->getActiveSheet()->SetCellValue('N'.$getRow2, get_aip_hdmf());
$objPHPExcel->getActiveSheet()->SetCellValue('O'.$getRow2, get_aip_ph());
$objPHPExcel->getActiveSheet()->SetCellValue('P'.$getRow2, get_aip_ecc());
$objPHPExcel->getActiveSheet()->SetCellValue('Q'.$getRow2, get_aip_other());

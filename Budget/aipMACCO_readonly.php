...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$total_mooe = $post_tev +  $post_training +  $post_office_supplies + $post_other_maintenance + $post_postage + $post_auditing;
	...
	$query = "UPDATE aip SET salaries = ?, PERA = ?, RA = ?, TA = ?, clothing_allowance = ?, year_end = ?, cash_gift = ?, 
							 ...
							 tev = ?, training_seminars = ?,  postage = ?, office_supplies = ?, auditing_services = ?, others = ?, total_mooe = ?, co = ?, total_co = ? WHERE departments = 'MACCO' && Year = ?  ";
...
<thead>
	...
	<th style="text-align: center;">Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="opb" name="opb" class="form-control" value="'.$opb.'" tabindex="14" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="tev" name="tev" class="form-control" value="'.$tv.'" tabindex="15" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="training" name="training" class="form-control" value="'.$tra.'" tabindex="16" step="any"></td>';
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 11 &#32; 020</td>
			<?PHP
			$aud = floatval(select_aip_auditing());
			echo '<td>'.number_format($aud,2).'</td>';
			echo '<td><input type="number" id="auditing" name="auditing" class="form-control" value="'.$aud.'" tabindex="19" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_auditing_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" class="form-control" value="'.$ot.'" tabindex="20" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control" value="'.$coo.'" tabindex="21" step="any"></td>';

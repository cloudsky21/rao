...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$post_fedility =  $_POST['fedility-insurance-premium'];
	$post_acc =  $_POST['accountable-forms'];
	$post_office_supplies =  $_POST['office-supplies'];
	$post_it_equipment =  $_POST['it-equipment'];
...
<thead>
	...
	<th style="text-align: center;">Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="tlb" name="tlb" class="form-control" value="'.$tlb.'" tabindex="14" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_tl_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="postage" name="postage" class="form-control" step="any" value="'.$po.'" tabindex="18"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="telephone" name="telephone" class="form-control" value="'.$phonegraph.'" tabindex="19" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="fedility-insurance-premium" name="fedility-insurance-premium" class="form-control" value="'.$fed.'" tabindex="20" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_fidelity_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="accountable-forms" name="accountable-forms" class="form-control" value="'.$account.'" tabindex="21" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_accountable_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="office-supplies" name="office-supplies" class="form-control" value="'.$off.'" tabindex="22" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="it-equipment" name="it-equipment" class="form-control" value="'.$it.'" tabindex="23" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_it_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" class="form-control" value="'.$ot.'" tabindex="24" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control" value="'.$coo.'" tabindex="25" step="any"></td>';

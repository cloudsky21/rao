...
$result = $db->prepare("SELECT sum(total) as total FROM psmbe WHERE year_transact = ?");
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmbe WHERE alobs = ?");
	$result->execute([$rec]);
...
<head>
	...
	<title>PS | Municipal Business Enterprise</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'details_mbe_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'edit_mbe_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					...
					type : 'post',
            url : 'delete_mbe_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Mun. Business Enterprise <small>Personal Services</small></h2>
			...
			<div class="modal fade" id="addObl" role="dialog">
				...
				<table class="table table-condensed table-striped table-hover table-striped">
					...
					<tbody>
						...
						$result = $db->prepare("SELECT * FROM psmbe WHERE year_transact = ?");

...
$result = $db->prepare("SELECT SUM(total) AS total FROM gsco WHERE yearm = ? AND month = ?");
...
<title>CO Report | General Services</title>
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="mooe_gs_all">Maintenance and Other Operating Expenses</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cgs1">January</a></li>
					<li><a href="cgs2">February</a></li>
					<li><a href="cgs3">March</a></li>
					<li><a href="cgs4">April</a></li>
					<li><a href="cgs5">May</a></li>
					<li><a href="cgs6">June</a></li>
					<li><a href="cgs7">July</a></li>
					<li><a href="cgs8">August</a></li>
					<li><a href="cgs9">September</a></li>
					<li><a href="cgs10">October</a></li>
					<li><a href="cgs11">November</a></li>
					<li><a href="cgs12">December</a></li>
...
<h2>General Services <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_gs - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM gsco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM gsco WHERE yearm = ? ");

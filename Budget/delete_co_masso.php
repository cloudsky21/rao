...
$query = "DELETE FROM massoco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Assessors Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_masso.php"  class="active">MASSO</a></li>
...
$result = $db->prepare("SELECT * FROM massoco WHERE yearm =?");

...
$result = $db->prepare("SELECT SUM(total) AS total FROM mswdco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mun. Social Welfare and Development Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmswd1">January</a></li>
					<li><a href="cmswd2">February</a></li>
					<li><a href="cmswd3">March</a></li>
					<li><a href="cmswd4">April</a></li>
					<li><a href="cmswd5">May</a></li>
					<li><a href="cmswd6">June</a></li>
					<li><a href="cmswd7">July</a></li>
					<li><a href="cmswd8">August</a></li>
					<li><a href="cmswd9">September</a></li>
					<li><a href="cmswd10">October</a></li>
					<li><a href="cmswd11">November</a></li>
					<li><a href="cmswd12">December</a></li>
...
<h2>Mun. Social Welfare and Development Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mswd - $total_9,2); ?></span></li>
			...
			<ul class="list-group col-sm-8">
				<li class="list-group-item"><label class="list-group-item-heading">Total: </label><p class="list-group-item-text"><?PHP echo number_format($total_9,2); ?></p></li>
...
$result = $db->prepare("SELECT * FROM mswdco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM mswdco WHERE yearm = ? ");

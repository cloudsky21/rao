...
<thead>
	...
	<th style="text-align: center;">Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="text" class="form-control" value="'.number_format(select_aip_salaries_bal(),2).'"  tabindex="0" readonly></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="PERA" name="PERA" class="form-control" step="any" value="'.$per.'" tabindex="2"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_pera_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="RA" name="RA" class="form-control" step="any" value="'.$ra.'" tabindex="3"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_ra_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="TA" name="TA" class="form-control" step="any" value="'.$ta.'" tabindex="4"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_ta_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="clothing_allowance" name="clothing_allowance" class="form-control" step="any" value="'.$clo.'" tabindex="5"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_cloth_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="year_end" name="year_end" class="form-control" step="any" value="'.$yend.'" tabindex="6"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_yend_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="cash_gift" name="cash_gift" class="form-control" step="any" value="'.$ca.'" tabindex="7"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_gft_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="mid_year" name="mid_year" class="form-control" step="any" value="'.$mid.'" tabindex="8"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_mid_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="pib" name="pib" class="form-control" step="any" value="'.$pi.'" tabindex="9"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_pib_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="gsis" name="gsis" class="form-control" step="any" value="'.$gs.'" tabindex="10"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_gsis_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="hdmf" name="hdmf" class="form-control" step="any" value="'.$hd.'" tabindex="11"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_hdmf_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="philHealth" name="philHealth" class="form-control" step="any" value="'.$care.'" tabindex="12"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_philhealth_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="ecc" name="ecc" class="form-control" step="any" value="'.$ec.'" tabindex="13"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_ecc_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="opb" name="opb" class="form-control" step="any" value="'.$opb.'" tabindex="14"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_opb_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="tev" name="tev" class="form-control" step="any" value="'.$tv.'" tabindex="15"></td>';
			echo '<td><input type="text" class="form-control" readonly value = "'.number_format(select_aip_travel_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="training" name="training" class="form-control" step="any" value="'.$tra.'" tabindex="16"></td>';
			echo '<td><input type="text" class="form-control" readonly value = "'.number_format(select_aip_training_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="office-supplies" name="office-supplies" step="any" class="form-control" value="'.$off.'" tabindex="18"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_office_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" step="any" class="form-control" value="'.$ot.'" tabindex="19"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_others_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control" step="any" value="'.$coo.'" tabindex="20"></td>';
			echo '<td><input type="text" id="total-balance-maintenance-expenses" name="total-balance-maintenance-expenses" class="form-control" readonly value="'.number_format(select_aip_co_bal(),2).'" tabindex="0"></td>';
			?>
		</tr>

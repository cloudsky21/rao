...
$table_cy = "rcont".$_SESSION['budget'];
...
{
	echo ("Setup Continuing Program First. This page will be redirected.. in 3 seconds");
	header('Refresh: 3; url=aipcontsetup');
	exit();
...
<title>Report | Continuing Program</title>
     ...
     <li><a class="dropdown-toggle" data-toggle="dropdown" href="#">Registry Allotment and Obligations (RAO)
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_none-office">Export to Excel</a></li>
	...
	<ul class="nav navbar-nav navbar-right">
	  ...
	  <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cnt1">January</a></li>
					<li><a href="cnt2">February</a></li>
					<li><a href="cnt3">March</a></li>
					<li><a href="cnt4">April</a></li>
					<li><a href="cnt5">May</a></li>
					<li><a href="cnt6">June</a></li>
					<li><a href="cnt7">July</a></li>
					<li><a href="cnt8">August</a></li>
					<li><a href="cnt9">September</a></li>
					<li><a href="cnt10">October</a></li>
					<li><a href="cnt11">November</a></li>
					<li><a href="cnt12">December</a></li>
...
<h2>Continuing Program <br><small>September <?php echo $_SESSION['budget'] ?></small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_cnt,2); ?></span></li>
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_cnt - $nt_9, 2); ?></span></li>

...
try
{
		$tbl_20_list = "gad_list_".$_SESSION['budget']; 
...
try
{
	...
	$tablename_20 = "gad".$_SESSION['budget'];
...
$get_longname = htmlentities($_POST['longname-edit']);
	...
	if($_POST['sector'] == "GENERAL PUBLIC SERVICES"){
		...
		$tb_list1 = "gad_list_".$_SESSION['budget'];
		...
		$tb_list2 = "gad_list_".$_SESSION['budget'];
...
$(document).ready(function(){
    $('#edit').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'editaipgad.php', //Here you will fetch records 
...
$(document).ready(function(){
    $('#delete').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'deleteaipgad.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
...
<div class="container">
	<div style="margin-top: 100px;">
		...
		<div class="page-header">
			<h2>Update Table of  Gender and Development</h2>
		</div>
  

			
				<label>Table: <STRONG>Gender and Development (<?PHP echo $_SESSION['budget'] ?>)</strong></label>&nbsp; &nbsp; <button class="btn btn-default btn-xs" data-toggle="modal" data-target="#addProgram"><span class="glyphicon glyphicon-plus"></span></button>  

...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="subsistence-allowance" name="subsistence-allowance" class="form-control" value="'.$subs.'" tabindex="14" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_sub_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="office-supplies" name="office-supplies" class="form-control" value="'.$off.'" tabindex="19" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="aics" name="aics" class="form-control" value="'.$aicss.'" tabindex="20" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_aics_bal(),2).'"></td>';
			?>
		</tr>

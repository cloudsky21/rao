...
$query = "DELETE FROM massomooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Assessors Office</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Assessors Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_masso.php"  class="active">MASSO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_masso_all.php">Personal Services</a>
  <a href="mooe_masso_all.php">Maint. and Other Operating Expenses</a>

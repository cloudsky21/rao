...
$query = "DELETE FROM psmao WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Agriculturists Office</title>
...
<body>
<label id="accountTitle">Personel Services - MAO - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_mao.php"  class="active">MAO</a></li>

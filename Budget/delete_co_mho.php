...
$query = "DELETE FROM mhoco WHERE alobs = ?";
$rs = $db->prepare($query);
...
<body>
<label id="accountTitle">Capital Outlay - Mun. Health Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_co_mho.php"  class="active">MHO</a></li>
...
$result = $db->prepare("SELECT * FROM mhoco WHERE yearm =?");

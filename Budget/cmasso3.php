...
<h2>Mun. Assessors's Office <br><small>Capital Outlay (March <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_masso - $total_3,2); ?></span></li>

...
$sqlExcel = "SELECT * FROM psmswd WHERE year_transact = '$yy'";
...
$objPHPExcel->getActiveSheet()->setTitle('PSMSWD');
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Social Welfare and Development Office');
...
$objPHPExcel->getActiveSheet()->SetCellValue('S13','Subsistence');
$objPHPExcel->getActiveSheet()->SetCellValue('S14','Allowance');

$objPHPExcel->getActiveSheet()->SetCellValue('T13','Other Personel');
$objPHPExcel->getActiveSheet()->SetCellValue('T14','Benefits');
...
while ($row = mysqli_fetch_assoc($result))
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('S'.$rowCount,$row['subsistenceAllowance']);
	$objPHPExcel->getActiveSheet()->SetCellValue('T'.$rowCount,$row['other_personel_benefits']);
...
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow, get_total_subsistence());
...
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow1, get_subsistence_bal());
...
$objPHPExcel->getActiveSheet()->SetCellValue('S'.$getRow2, get_aip_subsistence());

...
$query = "DELETE FROM mbemooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Business Enterprise</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Business Enterprise
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_mbe.php"  class="active">MARKET</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mbe_all.php">Personal Services</a>
  <a href="mooe_mbe_all.php">Maint. and Other Operating Expenses</a>

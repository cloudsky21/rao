...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="equipment" name="equipment" class="form-control" step="any" value="'.$ofequip.'"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_equip_bal(),2).'"></td>';
			?>
		</tr>

...
$result = $db->prepare("SELECT sum(total) as total FROM psmbo WHERE year_transact = ?");
...
$result->execute([$total, "MBO", $_SESSION['budget']]);
...
//numbers	
	...
	$result = $db->prepare("INSERT INTO psmbo (
		year_transact, 
		month_transact, 
		day_transact, 
		alobs, 
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmbo WHERE alobs = ?");
	$result->execute([$rec]);
...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmbo WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Municipal Budget Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mbo_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mbo_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mbo_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmbo1">January</a></li>
							<li><a href="pmbo2">February</a></li>
							<li><a href="pmbo3">March</a></li>
							<li><a href="pmbo4">April</a></li>
							<li><a href="pmbo5">May</a></li>
							<li><a href="pmbo6">June</a></li>
							<li><a href="pmbo7">July</a></li>
							<li><a href="pmbo8">August</a></li>
							<li><a href="pmbo9">September</a></li>
							<li><a href="pmbo10">October</a></li>
							<li><a href="pmbo11">November</a></li>
							<li><a href="pmbo12">December</a></li>
		...
		<div class="container">
			...
			<div style="margin-top: 100px;">
				...
				<div class="page-header">
					...
					<h2>Mun. Budget Office <small>Personal Services</small></h2>
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tbody>
						...
						$result = $db->prepare("SELECT * FROM psmbo WHERE year_transact = ? ORDER BY alobs DESC");

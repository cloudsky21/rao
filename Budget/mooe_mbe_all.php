...
$result->execute([$total, "MBE", $_SESSION['budget']]);
/* ------------------------------*/
get_total_trainings();
get_total_water();
get_total_officeSupplies();
get_total_Slaughterhouse();

get_trainings_bal();
get_water_bal();
get_officeSupplies_bal();
get_Slaughterhouse_bal();
?>
...
//numbers	
	...
	$post_s = $_POST['slaught'];	

	
	$totalObligation = $post_trainings  + $post_w + $post_supplies +  $post_s;

	$query = "INSERT INTO mbemooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM mbemooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE mbemooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM mbemooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | Municipal Business Enterprise (MARKET)</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mbe_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mbe_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mbe_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mbe_mooe">Export to Excel</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					<?php if($getlock == '0'){ echo '<?php if($getlock == '0'){ echo '<li><a href="#"  data-toggle="modal" data-target="#addObl"  data-backdrop="static" data-keyboard="false"><span class="glyphicon glyphicon-plus"></span></a></li>'; } else {} ?>'; } else {} ?>
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">

							<li><a href="mmbe1">January</a></li>
							<li><a href="mmbe2">February</a></li>
							<li><a href="mmbe3">March</a></li>
							<li><a href="mmbe4">April</a></li>
							<li><a href="mmbe5">May</a></li>
							<li><a href="mmbe6">June</a></li>
							<li><a href="mmbe7">July</a></li>
							<li><a href="mmbe8">August</a></li>
							<li><a href="mmbe9">September</a></li>
							<li><a href="mmbe10">October</a></li>
							<li><a href="mmbe11">November</a></li>
							<li><a href="mmbe12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td><input class="form-control"  type="number" step="any" name="slaught" min=0></td>
							</tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Mun. Business Enterprise <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM mbemooe WHERE yearm = ?");

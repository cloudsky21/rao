...
$checkTableExist = get_table_exist_noneoffice();

if($checkTableExist == '0'){

$isLoaded = check_if_loaded_noneoffice_aip();
		if ($isLoaded > 0){
	
			header("location: aipNoneOffice_readonly");
			exit();
			}
...
{
	header("location: aipnoneofficesetup");
	exit();
}
$tot = "";?>
?>
...
<?PHP
	...
	echo "<br>Please Setup Table First";

...
<title>MOOE Report | Mun. Assessors Office</title>
...
<h2>Mun. Assessors Office <br><small>Maintenance and Other Operating Expenses (September <?php echo $_SESSION['budget'] ?>)</small></h2>
...
$result = $db->prepare("SELECT * FROM massomooe WHERE yearm = ? AND month = ? ORDER BY alobs DESC");

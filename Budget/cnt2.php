...
<h2>Continuing Program <br><small>February <?php echo $_SESSION['budget'] ?></small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_cnt - $nt_2, 2); ?></span></li>

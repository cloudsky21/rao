...
$result = $db->prepare("SELECT SUM(total) AS total FROM mpdoco WHERE yearm = ? AND month = ?");
...
<title>CO Report | Mun. Planning and Development Office</title>
	...
	<ul class="nav navbar-nav navbar-right">
			 ...
			 <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
				<ul class="dropdown-menu">
					...
					<li><a href="cmpdo1">January</a></li>
					<li><a href="cmpdo2">February</a></li>
					<li><a href="cmpdo3">March</a></li>
					<li><a href="cmpdo4">April</a></li>
					<li><a href="cmpdo5">May</a></li>
					<li><a href="cmpdo6">June</a></li>
					<li><a href="cmpdo7">July</a></li>
					<li><a href="cmpdo8">August</a></li>
					<li><a href="cmpdo9">September</a></li>
					<li><a href="cmpdo10">October</a></li>
					<li><a href="cmpdo11">November</a></li>
					<li><a href="cmpdo12">December</a></li>
...
<h2>Mun. Planning and Development's Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_mpdo - $total_9,2); ?></span></li>
...
$result = $db->prepare("SELECT * FROM mpdoco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");
...
include("cfg.php");	
$result = $db->prepare("SELECT SUM(total) as total FROM mpdoco WHERE yearm = ? ");

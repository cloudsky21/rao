...
<h2>Sangguniang Bayan <br><small>Personal Services (July <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<ul class="list-group col-sm-4">
					...
					<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_sb - $ps_july_total,2); ?></span></li>

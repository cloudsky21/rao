...
$result->execute([$total, "General Services", $_SESSION['budget']]);
/* ------------------------------*/
get_total_tev();
...
//numbers	
	...
	$post_w = $_POST['water'];	
	$post_e = $_POST['electricity'];
	$post_g = $_POST['gas'];
	$post_mm = $_POST['mm'];	

	
	$totalObligation = $post_tev + $post_supplies + $post_w  + $post_e + $post_g +  $post_mm;

	$query = "INSERT INTO gsmooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM gsmooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE gsmooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
$result = $db->prepare("SELECT SUM(total) AS total FROM gsmooe WHERE yearm = ? AND month = ?");
...
<head>
	...
	<title>MOOE | General Services</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_gs_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_gs_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_gs_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_gs_mooe">Export to Excel</a></li>
							<li><a href="personal_services_gs_all">Personal Services</a></li>
							<li><a href="co_gs_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="mgs1">January</a></li>
							<li><a href="mgs2">February</a></li>
							<li><a href="mgs3">March</a></li>
							<li><a href="mgs4">April</a></li>
							<li><a href="mgs5">May</a></li>
							<li><a href="mgs6">June</a></li>
							<li><a href="mgs7">July</a></li>
							<li><a href="mgs8">August</a></li>
							<li><a href="mgs9">September</a></li>
							<li><a href="mgs10">October</a></li>
							<li><a href="mgs11">November</a></li>
							<li><a href="mgs12">December</a></li>
					...
					<form method ="POST" action="" name="form1">
						...
						<table class="table table-condensed borderless">
							...
							<tr>
								...
								<td><input class="form-control" type="number" step="any" name="water" min=0></td>
							</tr>
							<tr>
								<td>Electricity</td>
								<td class="help-block">02 &nbsp; 04 &nbsp; 020</td>
								<td><input class="form-control" type="number" step="any" name="electricity" min=0></td>
							</tr>
							
							<tr>
								<td>Gasoline, Oil<br> &amp; Lubricants</td>
								<td class="help-block">02 &nbsp; 13 &nbsp; 090</td>
								<td><input class="form-control" type="number" step="any" name="gas" min=0></td>
							</tr>
							
							<tr>
								<td>Motor Vehicle<br> Maintenance</td>
								<td class="help-block">02 &nbsp; 13 &nbsp;	060</td>
								<td><input class="form-control" type="number" step="any" name="mm" min=0></td>
							</tr>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>General Services <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM gsmooe WHERE yearm = ?");

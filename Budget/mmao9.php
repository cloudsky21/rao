...
<title>MOOE Report | Mun. Agriculturist Office</title>
...
<h2>Mun. Agriculturist Office <br><small>Maintenance and Other Operating Expenses (September <?php echo $_SESSION['budget'] ?>)</small></h2>
...
$result = $db->prepare("SELECT * FROM maomooe WHERE yearm = ? AND month = ? ORDER BY alobs DESC");

...
$sqlExcel = "SELECT * FROM sbmooe WHERE yearm = ?";
...
$objPHPExcel->getActiveSheet()->getStyle('B12:M14')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Sangguniang Bayan');
...
$objPHPExcel->getActiveSheet()->SetCellValue('K13','Office Supplies');
$objPHPExcel->getActiveSheet()->SetCellValue('K14','05   02   03   010');

$objPHPExcel->getActiveSheet()->SetCellValue('L13','Advertising Expenses');
$objPHPExcel->getActiveSheet()->SetCellValue('L14','05   02   99   010');

$objPHPExcel->getActiveSheet()->SetCellValue('M13','Other Maintenance and Operating Expenses');
...
$objPHPExcel->getActiveSheet()->getStyle('F12:M12')->applyFromArray($BStyle);
$objPHPExcel->getActiveSheet()->getStyle('F13:M14')->applyFromArray($BStyle);



$objPHPExcel->getActiveSheet()->getStyle('E15:M999')->getNumberFormat()->setFormatCode('#,##0.00');
...
foreach ($result as $row)
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('J'.$rowCount,$row['fidelity_b']);
	$objPHPExcel->getActiveSheet()->SetCellValue('K'.$rowCount,$row['officeSupplies']);
	$objPHPExcel->getActiveSheet()->SetCellValue('L'.$rowCount,$row['advertising_expenses']);
	$objPHPExcel->getActiveSheet()->SetCellValue('M'.$rowCount,$row['others_maint']);
...
$getRow = $rowCount + 1;
$objPHPExcel->getActiveSheet()->getStyle('A'.$getRow.':M'.$getRow)->applyFromArray($BStyle);
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow, get_total_fidelity_b());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow, get_total_officeSupplies());	
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow, get_total_ads());		
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow, get_total_others_maint());	
	


$getRow1 = $rowCount + 2;
$objPHPExcel->getActiveSheet()->getStyle('A'.$getRow1.':M'.$getRow1)->applyFromArray($BStyle);
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow1, get_fidelity_b_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow1, get_officeSupplies_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow1, get_ads_bal());
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow1, get_others_maint_bal());




$getRow2 = $rowCount + 3;
$objPHPExcel->getActiveSheet()->getStyle('A'.$getRow2.':M'.$getRow2)->applyFromArray($BStyle);
...
$objPHPExcel->getActiveSheet()->SetCellValue('J'.$getRow2, get_aip_fidelity());
$objPHPExcel->getActiveSheet()->SetCellValue('K'.$getRow2, get_aip_offsup());
$objPHPExcel->getActiveSheet()->SetCellValue('L'.$getRow2, get_aip_ads());
$objPHPExcel->getActiveSheet()->SetCellValue('M'.$getRow2, get_aip_others());

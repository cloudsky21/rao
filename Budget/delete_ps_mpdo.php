...
$query = "DELETE FROM psmpdo WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Planning Development Office</title>
...
<body>
<label id="accountTitle">Personel Services - MPDO - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_mpdo.php"  class="active">MPDO</a></li>
...
$result = $db->prepare("SELECT * FROM psmpdo WHERE year_transact =?");

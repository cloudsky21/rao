...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$post_motm =  $_POST['vehicle-maintenance'];
...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td>'.number_format($ec,2).'</td>';
			echo '<td><input type="number" id="hwb" name="hwb" class="form-control" value="'.$ec.'" tabindex="14" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_hwb_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="vehicle-maintenance" name="vehicle-maintenance" class="form-control" value="'.$motm.'" tabindex="23" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_motm_bal(),2).'"></td>';
			?>
			</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="telephone" name="telephone" class="form-control" value="'.$phonegraph.'" tabindex="24" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="other-maintenance" name="other-maintenance" class="form-control" value="'.$ot.'" tabindex="25" step="any"></td>';
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control" value="'.$coo.'" tabindex="26" step="any"></td>';

...
if($get_table_check == 1){
	...
	$table_aip = "lcpc".$_SESSION['budget'];
	$table_rao = "rlcpc".$_SESSION['budget'];
...
try
{
	...
	$tabler20 = "rlcpc".$_SESSION['budget'];
...
<div class="container">
	<div style="margin-top: 100px;">
		...
		<div class="page-header">
			<h2>Setup IRA - LCPC</h2>
		</div>
  

			
				<label>Table: <STRONG>IRA - LCPC Programs from previous year</strong> </label>  
						...
						<table  class="table table-condensed table-hover">
							...
							<tbody>
								...
								try{
									...
									$result = $db->prepare("SELECT * FROM lcpc_list_".$sget."");
									$result->execute();

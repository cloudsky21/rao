...
$query = "DELETE FROM maomooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Agriculturists Office</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Agriculturists Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_mao.php"  class="active">MAO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mao_all.php">Personal Services</a>
  <a href="mooe_mao_all.php">Maint. and Other Operating Expenses</a>

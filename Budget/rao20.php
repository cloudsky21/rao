...
{
	echo ("Setup AIP for 20% EDF. This page will be redirected.. in 3 seconds");
	header('Refresh: 3; url=aip20setup.php');
	exit();
...
$claimant = strtoupper(htmlentities(strtr( $claimant, $unwanted_array )));
...
$(document).ready(function(){
    $('#infoModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'details_20edf.php', //Here you will fetch records 
...
$(document).ready(function(){
    $('#editModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'edit_20edf.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
...
$(document).ready(function(){
    $('#deleteModal').on('show.bs.modal', function (e) {
        ...
        $.ajax({
			cache: false,
            type : 'post',
            url : 'delete_20edf.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
            }
	...
	<ul class="nav navbar-nav">
      ...
      <li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
		<ul class="dropdown-menu">
			...
			<li><a href="export_20_edf.php">Export to Excel</a></li>
							...
							<div class="col-sm-8">
								<select name="rao" id="rao" class="form-control">
										<?PHP 
											...
											$rao_list = "20_list_".$_SESSION['budget'];

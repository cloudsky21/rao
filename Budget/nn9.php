...
$table = "noneoffice".$_SESSION['budget'];
try{
	refresh_all();
}
catch(Exception $e)
{
	echo ("Setup AIP for None - Office. This page will be redirected.. in 3 seconds");
	header('Refresh: 3; url=aipnoneofficesetup');
	exit();
...
<head>
	...
	<title>Report | None Office</title>
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="nn1">January</a></li>
							<li><a href="nn2">February</a></li>
							<li><a href="nn3">March</a></li>
							<li><a href="nn4">April</a></li>
							<li><a href="nn5">May</a></li>
							<li><a href="nn6">June</a></li>
							<li><a href="nn7">July</a></li>
							<li><a href="nn8">August</a></li>
							<li><a href="nn9">September</a></li>
							<li><a href="nn10">October</a></li>
							<li><a href="nn11">November</a></li>
							<li><a href="nn12">December</a></li>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>None - Office <br><small>September <?php echo $_SESSION['budget'] ?></small></h2>
			...
			<ul class="list-group col-sm-4">
				...
				<li class="list-group-item">Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_nn,2); ?></span></li>
				<li class="list-group-item">Balance Allotment (Per Quarter) <span class="badge"><?PHP echo number_format($allotment_nn - $nt_9, 2); ?></span></li>

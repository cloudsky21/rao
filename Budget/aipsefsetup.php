...
if($get_table_check == 1){
	...
	$table_aip = "sef".$_SESSION['budget'];
	$table_rao = "rsef".$_SESSION['budget'];
...
try
{
	...
	$insert_to_db->execute([$_POST['for-code'], $_POST['for-name'], $_POST['for-type'], $_POST['others']]);
...
<div class="container">
	<div style="margin-top: 100px;">
		...
		<div class="page-header">
			<h2>Setup None Office</h2>
		</div>
  

			
				<label>Table: <STRONG>Special Education Fund programs from previous year</strong> </label>  
						...
						<table  class="table table-condensed table-hover">
							...
							<tbody>
								...
								try{
									...
									$result = $db->prepare("SELECT * FROM sef_list_".$sget."");
									$result->execute();

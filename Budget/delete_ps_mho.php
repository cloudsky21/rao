...
$query = "DELETE FROM psmho WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Health Office</title>
...
<body>
<label id="accountTitle">Personel Services - MHO - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_mho.php"  class="active">MHO</a></li>
...
$result = $db->prepare("SELECT * FROM psmho WHERE year_transact =?");

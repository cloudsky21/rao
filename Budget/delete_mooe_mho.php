...
$query = "DELETE FROM mhomooe WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete MOOE | Mun. Health Office</title>
...
<body>
<label id="accountTitle">Maint. and Other Operating Expenses - Mun. Health Office
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_mooe_mho.php"  class="active">MHO</a></li>
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="personal_services_mho_all.php">Personal Services</a>
  <a href="mooe_mho_all.php">Maint. and Other Operating Expenses</a>

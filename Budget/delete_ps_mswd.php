...
$query = "DELETE FROM psmswd WHERE alobs = ?";
$rs = $db->prepare($query);
...
<title>Delete PS | Mun. Social Welfare Office</title>
...
<body>
<label id="accountTitle">Personel Services - MSWD - Delete ALOBS
</label>
<div id="container">
	<div class="wrap">
		<ul>
			...
			<li><a href="delete_ps_mswd.php"  class="active">MSWD</a></li>

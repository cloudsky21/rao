...
$sqlExcel = "SELECT * FROM psmpdo WHERE year_transact = '$yy'";
...
$objPHPExcel->getActiveSheet()->SetCellValue('B9', 'Municipal Planning and Development Office');
...
$objPHPExcel->getActiveSheet()->SetCellValue('S13','Other Bonuses');
$objPHPExcel->getActiveSheet()->SetCellValue('S14','and Allowances');
...
while ($row = mysqli_fetch_assoc($result))
{
	...
	$objPHPExcel->getActiveSheet()->SetCellValue('S'.$rowCount,$row['other_allowance_bonuses']);

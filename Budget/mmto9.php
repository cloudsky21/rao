...
<head>
	...
	<title>MOOE Report | Mun. Treasurers Office</title>
	...
	<div class="container">
		...
		<div style="margin-top: 100px;">
			...
			<div class="page-header">
				...
				<h2>Mun. Treasurer's Office <br><small>Maintenance and Other Operating Expenses (September <?php echo $_SESSION['budget'] ?>)</small></h2>
			...
			<table class="table table-condensed table-hover table-bordered">
				...
				<tbody>
					...
					$result = $db->prepare("SELECT * FROM mtomooe WHERE yearm = ? AND month = ? ORDER BY alobs DESC");

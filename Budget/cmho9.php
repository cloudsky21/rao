...
<title>CO Report | Mun. Health Office</title>
...
<h2>Mun. Health Office <br><small>Capital Outlay (September <?php echo $_SESSION['budget'] ?>)</small></h2>
...
$result = $db->prepare("SELECT * FROM mhoco WHERE yearm = ? AND month = ? ORDER BY alobs DESC");

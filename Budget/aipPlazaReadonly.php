...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$post_electricity =  $_POST['electricity'];
	$post_gasoline =  $_POST['gasoline'];
	$post_vehicle =  $_POST['vehicle-maintenance'];
...
<thead>
	...
	<th>Balance<br>&#40;4&#41;</th>
		...
		<tr>
			...
			echo '<td><input type="number" id="water" name="water" class="form-control" value="'.$water.'" tabindex="17" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_water_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="electricity" name="electricity" class="form-control" value="'.$ele.'" tabindex="17" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_electricity_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="gasoline" name="gasoline" class="form-control" value="'.$gas.'" tabindex="18" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_gasoline_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="vehicle-maintenance" name="vehicle-maintenance" class="form-control" value="'.$veh.'" tabindex="19" step="any"></td>';
			echo '<td><input type="text" class="form-control" readonly value="'.number_format(select_aip_vehicle_bal(),2).'"></td>';
			?>
		</tr>
		...
		<tr>
			...
			echo '<td><input type="number" id="capital-outlay" name="capital-outlay" class="form-control" value="'.$coo.'"></td>';

...
$isLoaded = check_if_loaded_mto_aip();
		if ($isLoaded == '1'){
			...
			header("location: aipMTO_readonly");
			}
...
if($_SERVER["REQUEST_METHOD"]=="POST"){
	...
	$post_fed_ins =   $_POST['fedility-insurance-premium'];
	$post_account =   $_POST['accountable-forms'];
	$post_office_supplies =  $_POST['office-supplies'];
	$post_it =   $_POST['it-equipment'];
	...
	$query = "INSERT INTO aip (Year, departments, deptName, headOfOffice, sector, refCode, salaries, PERA, RA, TA, clothing_allowance, year_end, cash_gift, mid_year, pib, life_retirement, pag_ibig, philHealth, ecc, terminal_leave, other_personal, total_ps,
...
<thead>
	...
	<th style="text-align: center;">Budget Year Proposed<br>&#40;<?PHP echo $_SESSION['budget']; ?>&#41;</th>
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td><input type="number" id="tlb" name="tlb" class="form-control" step="any" ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 16 &#32; 020</td>
			<td><input type="number" id="fedility-insurance-premium" name="fedility-insurance-premium" class="form-control" step="any" ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 03 &#32; 020</td>
			<td><input type="number" id="accountable-forms" name="accountable-forms" class="form-control" step="any" ></td>
		...
		<tr>
			...
			<td>5&#32; 02 &#32; 13 &#32; 050</td>
			<td><input type="number" id="it-equipment" name="it-equipment" class="form-control" step="any" ></td>
		...
		<tr>
			<td colspan="5"><button class="btn btn-success form-control" type="submit" name="SUBMIT">Submit</button></td>
		</tr>

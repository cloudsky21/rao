...
//numbers	
	...
	$totalObligation = $post_tev + $post_trainings + $post_post + $post_supplies + $post_others;

	$query = "INSERT INTO lcrmooe (
	yearm, 
	month, 
	day, 
	alobs, 
...
if(isset($_POST['delete'])){
	...
	$result = $db->prepare("DELETE FROM lcrmooe WHERE alobs = ?");
...
//numbers	
	...
	$result = $db->prepare("UPDATE lcrmooe SET 
		yearm=?, 
		month=?, 
		day=?, 
		alobs=?, 
...
<head>
	...
	<title>MOOE | Local Civil Registrar</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_lcr_mooe.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_lcr_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_lcr_mooe.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_lcr_mooe">Export to Excel</a></li>
	...
	<div class="container">
		<div style="margin-top: 100px;">
			<div class="page-header">
				<h2>Local Civil Registrar <small>Maintenance and Other Operating Expenses</small></h2>
			</div>
			...
			<table class="table table-condensed table-hover table-striped">
				...
				<tbody>
					...
					$query2 = "SELECT * FROM lcrmooe WHERE yearm = ?";

...
$result = $db->prepare("SELECT sum(total) as total FROM psmho WHERE year_transact = ?");
...
$result->execute([$total, "MHO", $_SESSION['budget']]);
...
//numbers	
	...
	$totalObligation = $post_salary +  	$post_pera +$post_ra + $post_ta + $post_cloth+$post_yend+$post_gft+$post_mid+$post_pib+$post_gsis+$post_hdmf+$post_care+$post_ecc + $post_hwb +$post_others;

	$query = "INSERT INTO psmho (
	year_transact, 
	month_transact, 
	day_transact, 
	alobs, 
...
if(isset($_POST['delete_ps'])){
	...
	$result = $db->prepare("DELETE FROM psmho WHERE alobs = ?");
	$result->execute([$rec]);
...
$result = $db->prepare("SELECT SUM(total) AS total FROM psmho WHERE year_transact = ? AND month_transact = ?");
...
<head>
	...
	<title>PS | Municipal Health Office</title>
		...
		$(document).ready(function(){
			$('#infoModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'details_mho_ps.php', //Here you will fetch records 
		...
		$(document).ready(function(){
			$('#editModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'edit_mho_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
		...
		$(document).ready(function(){
			$('#deleteModal').on('show.bs.modal', function (e) {
				...
				$.ajax({
					cache: false,
					type : 'post',
            url : 'delete_mho_ps.php', //Here you will fetch records 
            data :  'rowid='+ rowid, //Pass $id
            success : function(data){
            $('.edit-data').html(data);//Show fetched data from database
        }
				...
				<ul class="nav navbar-nav">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Settings<span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="export_mho_ps">Export to Excel</a></li>
							<li><a href="mooe_mho_all">Maint. and Other Operating Expenses</a></li>
							<li><a href="co_mho_all">Capital Outlay</a></li>
				...
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a  class="dropdown-toggle" data-toggle="dropdown" href="#">Reports <span class="caret"></span></a>
						<ul class="dropdown-menu">
							...
							<li><a href="pmho1">January</a></li>
							<li><a href="pmho2">February</a></li>
							<li><a href="pmho3">March</a></li>
							<li><a href="pmho4">April</a></li>
							<li><a href="pmho5">May</a></li>
							<li><a href="pmho6">June</a></li>
							<li><a href="pmho7">July</a></li>
							<li><a href="pmho8">August</a></li>
							<li><a href="pmho9">September</a></li>
							<li><a href="pmho10">October</a></li>
							<li><a href="pmho11">November</a></li>
							<li><a href="pmho12">December</a></li>
						...
						<table class="table table-condensed borderless">
							<tbody>
								...
								<tr >
									...
									<td><input class="form-control" type="text" id="claimant" name="claimant" placeholder="Juan Dela Cruz et. al." required></tr>
									</tr>
									<tr>
									...
									<tr>
										...
										<td><input type="number" step="any" name="ta" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>Clothing Allowance</td>
										<td class="textc">01 &nbsp; 02 &nbsp;	040</td>
										<td><input type="number" step="any" name="cloth" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>Year End Bonus</td>
										<td class="textc">01 &nbsp; 02 &nbsp;	140</td>
										<td><input type="number" step="any" name="year_end" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>Cash Gift</td>
										<td class="textc">01 &nbsp; 02 &nbsp;	150</td>
										<td><input type="number" step="any" name="cash_gift" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>Mid-Year Bonus</td>
										<td class="textc">01 &nbsp; 02 &nbsp;	990-1</td>
										<td><input type="number" step="any" name="mid_year" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>PIB</td>
										<td class="textc">01 &nbsp; 02 &nbsp;	080</td>
										<td><input type="number" step="any" name="pib" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>Life &amp; Retirement Insurance</td>
										<td class="textc">01 &nbsp; 03 &nbsp;	010</td>
										<td><input type="number" step="any" name="gsis" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>Pag-Ibig Contributions</td>
										<td class="textc">01 &nbsp; 03 &nbsp;	020</td>
										<td><input type="number" step="any" name="hdmf" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>PHILHEALTH Contributions</td>
										<td class="textc">01 &nbsp; 03 &nbsp;	030</td>
										<td><input type="number" step="any" name="care" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>ECC Contributions</td>
										<td class="textc">01 &nbsp; 03 &nbsp;	040</td>
										<td><input type="number" step="any" name="ecc" min=0 class="form-control"></td>
									</tr>
									<tr>
										<td>Health Workers Benefits</td>
										<td class="textc">&nbsp;</td>
										<td><input type="number" step="any" name="hwb" min=0  class="form-control"></td>
									</tr>
									<tr>
		...
		<div class="container">
			...
			<div style="margin-top: 100px;">
				...
				<div class="page-header">
					...
					<h2>Mun. Health Office <small>Personal Services</small></h2>
				...
				<table class="table table-condensed table-hover table-striped">
					...
					<tbody>
						...
						$result = $db->prepare("SELECT * FROM psmho WHERE year_transact = ? ORDER BY alobs DESC");
